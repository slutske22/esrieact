...
See https://js.arcgis.com/4.33/esri/copyright.txt for details.
*/
class o{async extract(e){const t=c(e),n=(0,edgeProcessing/* extract */.o6)(t),r=[t.data.buffer];return{result:EdgeProcessingWorker_u(n,r),transferList:r}}async extractComponentsEdgeLocations(t){const s=c(t),i=(0,edgeProcessing/* extractEdgeInformation */.hx)(s.data,s.skipDeduplicate,s.indices,s.indicesLength),a=(0,edgePreprocessing/* extractEdges */.K)(i,p),o=[];return{result:u(a.regular.instancesData,o),transferList:o}}async extractEdgeLocations(t){const s=c(t),i=(0,edgeProcessing/* extractEdgeInformation */.hx)(s.data,s.skipDeduplicate,s.indices,s.indicesLength),a=(0,edgePreprocessing/* extractEdges */.K)(i,f),o=[];return{result:u(a.regular.instancesData,o),transferList:o}}}function c(e){return{data:bufferLayouts/* EdgeInputBufferLayout */.I$.createView(e.dataBuffer),indices:"Uint32Array"===e.indicesType?new Uint32Array(e.indices):"Uint16Array"===e.indicesType?new Uint16Array(e.indices):e.indices,indicesLength:e.indicesLength,writerSettings:e.writerSettings,skipDeduplicate:e.skipDeduplicate}}function EdgeProcessingWorker_u(t,n){n.push(t.regular.lodInfo.lengths.buffer),n.push(t.silhouette.lodInfo.lengths.buffer);return{regular:{instancesData:u(t.regular.instancesData,n),lodInfo:{lengths:t.regular.lodInfo.lengths.buffer}},silhouette:{instancesData:u(t.silhouette.instancesData,n),lodInfo:{lengths:t.silhouette.lodInfo.lengths.buffer}},averageEdgeLength:t.averageEdgeLength}}class l{allocate(e){return edgeProcessing/* extractEdgeLocationsLayout */.Jb.createBuffer(e)}trim(e,t){return e.slice(0,t)}write(e,t,n){e.position0.setVec(t,n.position0),e.position1.setVec(t,n.position1)}}class d{allocate(e){return edgeProcessing/* extractComponentsEdgeLocationsLayout */.HY.createBuffer(e)}trim(e,t){return e.slice(0,t)}write(e,t,n){e.position0.setVec(t,n.position0),e.position1.setVec(t,n.position1),e.componentIndex.set(t,n.componentIndex)}}const f=new l,p=new d;
