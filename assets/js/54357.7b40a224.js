...
See https://js.arcgis.com/4.33/esri/copyright.txt for details.
*/
const i=i=>{let s=class extends i{constructor(...r){super(...r),this.layerViews=new Collection/* default */.A}get dynamicGroupLayerView(){return this.layerViews.find((r=>r.layer===this.layer?.dynamicGroupLayer))}get footprintLayerView(){return this.layerViews.find((r=>r.layer===this.layer?.footprintLayer))}isUpdating(){return!this.dynamicGroupLayerView||!this.footprintLayerView||this.dynamicGroupLayerView.updating||this.footprintLayerView.updating}};return (0,tslib_es6._)([(0,property/* property */.MZ)()],s.prototype,"layer",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)()],s.prototype,"layerViews",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({readOnly:!0})],s.prototype,"dynamicGroupLayerView",null),(0,tslib_es6._)([(0,property/* property */.MZ)({readOnly:!0})],s.prototype,"footprintLayerView",null),s=(0,tslib_es6._)([(0,subclass/* subclass */.$)("esri.views.layers.CatalogLayerView")],s),s};
...
See https://js.arcgis.com/4.33/esri/copyright.txt for details.
*/
let l=class extends(i((0,LayerView2D/* LayerView2DMixin */.e)(LayerView/* default */.A))){constructor(){super(...arguments),this.layerViews=new Collection/* default */.A}update(e){}viewChange(){}moveEnd(){}attach(){this.addAttachHandles([this._updatingHandles.addOnCollectionChange((()=>this.layerViews),(()=>this._updateStageChildren()),{initial:!0})])}detach(){this.container.removeAllChildren()}_updateStageChildren(){this.container.removeAllChildren(),this.layerViews.forEach(((e,r)=>this.container.addChildAt(e.container,r)))}};(0,tslib_es6._)([(0,property/* property */.MZ)()],l.prototype,"layerViews",void 0),l=(0,tslib_es6._)([(0,subclass/* subclass */.$)("esri.views.2d.layers.CatalogLayerView2D")],l);const c=l;
