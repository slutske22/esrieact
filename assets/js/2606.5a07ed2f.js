...
// EXTERNAL MODULE: ../node_modules/@esri/calcite-components/dist/components/popover.js + 3 modules
var popover = __webpack_require__(27583);
...
const Panel = /*@__PURE__*/ (0,client/* proxyCustomElement */.w$)(class extends client/* HTMLElement */.wt {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
    this.calcitePanelClose = (0,client/* createEvent */.lh)(this, "calcitePanelClose", 6);
    this.calcitePanelToggle = (0,client/* createEvent */.lh)(this, "calcitePanelToggle", 6);
    this.calcitePanelScroll = (0,client/* createEvent */.lh)(this, "calcitePanelScroll", 6);
  ...
  renderHeaderContent() {
    ...
    const descriptionNode = description ? (0,client.h)("span", { class: CSS.description }, description) : null;
    return !hasHeaderContent && (headingNode || descriptionNode) ? ((0,client.h)("div", { class: CSS.headerContent, key: "header-content" }, headingNode, descriptionNode)) : null;
  }
  renderActionBar() {
    return ((0,client.h)("div", { class: CSS.actionBarContainer, hidden: !this.hasActionBar }, (0,client.h)("slot", { name: SLOTS.actionBar, onSlotchange: this.handleActionBarSlotChange })));
  }
  renderHeaderSlottedContent() {
    return ((0,client.h)("div", { class: CSS.headerContent, hidden: !this.hasHeaderContent, key: "slotted-header-content" }, (0,client.h)("slot", { name: SLOTS.headerContent, onSlotchange: this.handleHeaderContentSlotChange })));
  }
  renderHeaderStartActions() {
    const { hasStartActions } = this;
    return ((0,client.h)("div", { class: { [CSS.headerActionsStart]: true, [CSS.headerActions]: true }, hidden: !hasStartActions, key: "header-actions-start" }, (0,client.h)("slot", { name: SLOTS.headerActionsStart, onSlotchange: this.handleHeaderActionsStartSlotChange })));
  }
  renderHeaderActionsEnd() {
    ...
    const closeNode = closable ? ((0,client.h)("calcite-action", { "aria-label": close, "data-test": "close", icon: ICONS.close, onClick: this.close, text: close, title: close })) : null;
    const slotNode = ((0,client.h)("slot", { name: SLOTS.headerActionsEnd, onSlotchange: this.handleHeaderActionsEndSlotChange }));
    const showContainer = hasEndActions || collapseNode || closeNode || hasMenuItems;
    return ((0,client.h)("div", { class: { [CSS.headerActionsEnd]: true, [CSS.headerActions]: true }, hidden: !showContainer, key: "header-actions-end" }, slotNode, this.renderMenu(), collapseNode, closeNode));
  }
  renderMenu() {
    const { hasMenuItems, messages, menuOpen } = this;
    return ((0,client.h)("calcite-action-menu", { flipPlacements: ["top", "bottom"], hidden: !hasMenuItems, key: "menu", label: messages.options, open: menuOpen, placement: "bottom-end" }, (0,client.h)("calcite-action", { icon: ICONS.menu, slot: action_menu.S.trigger, text: messages.options }), (0,client.h)("slot", { name: SLOTS.headerMenuActions, onSlotchange: this.handleHeaderMenuActionsSlotChange })));
  }
  renderHeaderNode() {
    ...
    return ((0,client.h)("header", { class: CSS.header, hidden: !(showHeaderContent || hasActionBar) }, (0,client.h)("div", { class: { [CSS.headerContainer]: true, [CSS.headerContainerBorderEnd]: hasActionBar }, hidden: !showHeaderContent }, this.renderHeaderStartActions(), this.renderHeaderSlottedContent(), headerContentNode, this.renderHeaderActionsEnd()), this.renderActionBar()));
  }
  renderFooterNode() {
    const { hasFooterContent, hasFooterActions } = this;
    const showFooter = hasFooterContent || hasFooterActions;
    return ((0,client.h)("footer", { class: CSS.footer, hidden: !showFooter }, (0,client.h)("slot", { key: "footer-slot", name: SLOTS.footer, onSlotchange: this.handleFooterSlotChange }), (0,client.h)("slot", { key: "footer-actions-slot", name: SLOTS.footerActions, onSlotchange: this.handleFooterActionsSlotChange })));
  }
  renderContent() {
    return ((0,client.h)("div", { class: CSS.contentWrapper, hidden: this.collapsible && this.collapsed, onScroll: this.panelScrollHandler,
      // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
      ref: this.setPanelScrollEl }, (0,client.h)("slot", null), this.renderFab()));
  }
  renderFab() {
    return ((0,client.h)("div", { class: CSS.fabContainer, hidden: !this.hasFab }, (0,client.h)("slot", { name: SLOTS.fab, onSlotchange: this.handleFabSlotChange })));
  }
  render() {
    const { loading, panelKeyDownHandler, closed, closable } = this;
    const panelNode = ((0,client.h)("article", { "aria-busy": (0,dom.t)(loading), class: CSS.container, hidden: closed, onKeyDown: panelKeyDownHandler, tabIndex: closable ? 0 : -1,
      // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
      ref: this.setContainerRef }, this.renderHeaderNode(), this.renderContent(), this.renderFooterNode()));
    return ((0,client.h)(client/* Fragment */.FK, null, loading ? (0,client.h)("calcite-scrim", { loading: loading }) : null, panelNode));
  }
  static get assetsDirs() { return ["assets"]; }
  get el() { return this; }
  static get watchers() { return {
...
const FlowItem = /*@__PURE__*/ (0,client/* proxyCustomElement */.w$)(class extends client/* HTMLElement */.wt {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
    this.calciteFlowItemBack = (0,client/* createEvent */.lh)(this, "calciteFlowItemBack", 7);
    this.calciteFlowItemScroll = (0,client/* createEvent */.lh)(this, "calciteFlowItemScroll", 6);
    this.calciteFlowItemClose = (0,client/* createEvent */.lh)(this, "calciteFlowItemClose", 6);
    this.calciteFlowItemToggle = (0,client/* createEvent */.lh)(this, "calciteFlowItemToggle", 6);
    // --------------------------------------------------------------------------
    //
    //  Private Methods
    //
  ...
  render() {
    ...
    return ((0,client.h)(client/* Host */.xr, null, (0,client.h)("calcite-panel", { closable: closable, closed: closed, collapseDirection: collapseDirection, collapsed: collapsed, collapsible: collapsible, description: description, disabled: disabled, heading: heading, headingLevel: headingLevel, loading: loading, menuOpen: menuOpen, messageOverrides: messages, onCalcitePanelClose: this.handlePanelClose, onCalcitePanelScroll: this.handlePanelScroll, onCalcitePanelToggle: this.handlePanelToggle,
      // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
      ref: this.setContainerRef }, this.renderBackButton(), (0,client.h)("slot", { name: calcite_flow_item_SLOTS.actionBar, slot: SLOTS.actionBar }), (0,client.h)("slot", { name: calcite_flow_item_SLOTS.headerActionsStart, slot: SLOTS.headerActionsStart }), (0,client.h)("slot", { name: calcite_flow_item_SLOTS.headerActionsEnd, slot: SLOTS.headerActionsEnd }), (0,client.h)("slot", { name: calcite_flow_item_SLOTS.headerContent, slot: SLOTS.headerContent }), (0,client.h)("slot", { name: calcite_flow_item_SLOTS.headerMenuActions, slot: SLOTS.headerMenuActions }), (0,client.h)("slot", { name: calcite_flow_item_SLOTS.fab, slot: SLOTS.fab }), (0,client.h)("slot", { name: calcite_flow_item_SLOTS.footerActions, slot: SLOTS.footerActions }), (0,client.h)("slot", { name: calcite_flow_item_SLOTS.footer, slot: SLOTS.footer }), (0,client.h)("slot", null))));
  }
  static get assetsDirs() { return ["assets"]; }
  get el() { return this; }
  static get watchers() { return {
...
function getDebouncedReposition(component) {
  ...
  debounced = (0,debounce.d)(positionFloatingUI, repositionDebounceTimeout, {
    leading: true,
...
function connectFloatingUI(component, referenceEl, floatingEl) {
  ...
  const runAutoUpdate = client/* Build */.L2.isBrowser
    ? autoUpdate
...
const FloatingArrow = ({ floatingLayout, key, ref, }) => {
  ...
  const dValue = "M0,0" +
    ...
    " Z";
  return ((0,client.h)("svg", { "aria-hidden": "true", class: FloatingArrow_CSS.arrow, height: width, key: key, viewBox: `0 0 ${width} ${width + (!isVertical ? strokeWidth : 0)}`, width: width + (isVertical ? strokeWidth : 0), 
    // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
    ref: ref },
    strokeWidth > 0 && ((0,client.h)("path", { class: FloatingArrow_CSS.arrowStroke, d: dValue, fill: "none", "stroke-width": strokeWidth + 1 })),
    (0,client.h)("path", { d: dValue, stroke: "none" })));
};
...
const Popover = /*@__PURE__*/ (0,client/* proxyCustomElement */.w$)(class extends client/* HTMLElement */.wt {
  ...
  renderCloseButton() {
    ...
    return closable ? ((0,client.h)("div", { class: popover_CSS.closeButtonContainer, key: popover_CSS.closeButtonContainer }, (0,client.h)("calcite-action", { appearance: "transparent", class: popover_CSS.closeButton, onClick: this.hide, scale: this.scale, text: messages.close,
      // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
  ...
  renderHeader() {
    ...
    const headingNode = heading ? ((0,client.h)(Heading.H, { class: popover_CSS.heading, level: headingLevel }, heading)) : null;
    return headingNode ? ((0,client.h)("div", { class: popover_CSS.header, key: popover_CSS.header }, headingNode, this.renderCloseButton())) : null;
  }
  render() {
    const { effectiveReferenceElement, heading, label, open, pointerDisabled, floatingLayout } = this;
    const displayed = effectiveReferenceElement && open;
    const hidden = !displayed;
    const arrowNode = !pointerDisabled ? ((0,client.h)(FloatingArrow, { floatingLayout: floatingLayout, key: "floating-arrow",
      // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
    ...
    return ((0,client.h)(client/* Host */.xr, { "aria-hidden": (0,dom.t)(hidden), "aria-label": label, "aria-live": "polite", "calcite-hydrated-hidden": hidden, id: this.getId(), role: "dialog" }, (0,client.h)("div", { class: {
      ...
      ref: this.setTransitionEl }, arrowNode, (0,client.h)("div", { class: {
        [popover_CSS.hasHeader]: !!heading,
        [popover_CSS.container]: true,
      } }, this.renderHeader(), (0,client.h)("div", { class: popover_CSS.content }, (0,client.h)("slot", null)), !heading ? this.renderCloseButton() : null))));
  }
  static get assetsDirs() { return ["assets"]; }
  get el() { return this; }
  static get watchers() { return {
