...
/* harmony export */   saveAs: () => (/* binding */ I)
/* harmony export */ });
...
*/
const o="Map Service",l="map-image-layer-save",m="map-image-layer-save-as";function c(e){return{isValid:"map-image"===e.type&&!e.sourceJSON?.tileInfo,errorMessage:"Layer.type should be 'map-image' and reference a dynamic (non-cached) map service"}}function p(e){const t=e.layerJSON;return Promise.resolve(t&&Object.keys(t).length?t:null)}function u(e,t){return f(e,t),Promise.resolve()}async function y(e,t){const{parsedUrl:s,title:i,fullExtent:o}=e;t.url=s.path,t.title||=i,t.extent=o?await (0,_portal_support_portalItemUtils_js__WEBPACK_IMPORTED_MODULE_1__/* .getWGS84ExtentForItem */ .sQ)(o):null,(0,_portal_support_portalItemUtils_js__WEBPACK_IMPORTED_MODULE_1__/* .removeTypeKeyword */ .OM)(t,_portal_support_portalItemUtils_js__WEBPACK_IMPORTED_MODULE_1__/* .typeKeyword */ .mm.METADATA),f(e,t)}function f(e,t){(0,_portal_support_portalItemUtils_js__WEBPACK_IMPORTED_MODULE_1__/* .addTypeKeyword */ .LG)(t,_portal_support_portalItemUtils_js__WEBPACK_IMPORTED_MODULE_1__/* .typeKeyword */ .mm.DYNAMIC);const r=e.sublayers?.length??0;(0,_portal_support_portalItemUtils_js__WEBPACK_IMPORTED_MODULE_1__/* .toggleTypeKeyword */ .Sm)(t,_portal_support_portalItemUtils_js__WEBPACK_IMPORTED_MODULE_1__/* .typeKeyword */ .mm.MULTI_LAYER,r>1),(0,_portal_support_portalItemUtils_js__WEBPACK_IMPORTED_MODULE_1__/* .toggleTypeKeyword */ .Sm)(t,_portal_support_portalItemUtils_js__WEBPACK_IMPORTED_MODULE_1__/* .typeKeyword */ .mm.SINGLE_LAYER,1===r)}async function v(t,r){return (0,_utils_js__WEBPACK_IMPORTED_MODULE_0__/* .save */ .UN)({layer:t,itemType:o,validateLayer:c,createItemData:p,errorNamePrefix:l,setItemProperties:u},r)}async function I(e,r,a){return (0,_utils_js__WEBPACK_IMPORTED_MODULE_0__/* .saveAs */ .Uh)({layer:e,itemType:o,validateLayer:c,createItemData:p,errorNamePrefix:m,newItem:r,setItemProperties:y},a)}
