...
var calcite_action = __webpack_require__(11077);
// EXTERNAL MODULE: ./node_modules/@esri/calcite-components/dist/components/calcite-action-menu/index.js + 5 modules
var calcite_action_menu = __webpack_require__(14507);
...
class Panel extends dist/* LitElement */.WF {
  ...
  renderHeaderContent() {
    ...
    const headingNode = heading ? (0,Heading.H)({ class: resources3_CSS.heading, level: headingLevel, children: heading }) : null;
    const descriptionNode = description ? (0,lit/* html */.qy)`<span class=${(0,dist/* safeClassMap */.CP)(resources3_CSS.description)}>${description}</span>` : null;
    return !hasHeaderContent && (headingNode || descriptionNode) ? (0,keyed/* keyed */.D)("header-content", (0,lit/* html */.qy)`<div class=${(0,dist/* safeClassMap */.CP)(resources3_CSS.headerContent)}>${headingNode}${descriptionNode}</div>`) : null;
  }
  renderActionBar() {
    return (0,lit/* html */.qy)`<div class=${(0,dist/* safeClassMap */.CP)(resources3_CSS.actionBarContainer)} .hidden=${!this.hasActionBar}><slot name=${SLOTS.actionBar} @slotchange=${this.handleActionBarSlotChange}></slot></div>`;
  }
  renderHeaderSlottedContent() {
    return (0,keyed/* keyed */.D)("slotted-header-content", (0,lit/* html */.qy)`<div class=${(0,dist/* safeClassMap */.CP)({ [resources3_CSS.headerContent]: true, [resources3_CSS.headerSlottedContent]: true })} .hidden=${!this.hasHeaderContent}><slot name=${SLOTS.headerContent} @slotchange=${this.handleHeaderContentSlotChange}></slot></div>`);
  }
  renderHeaderStartActions() {
    const { hasStartActions } = this;
    return (0,keyed/* keyed */.D)("header-actions-start", (0,lit/* html */.qy)`<div class=${(0,dist/* safeClassMap */.CP)({ [resources3_CSS.headerActionsStart]: true, [resources3_CSS.headerActions]: true })} .hidden=${!hasStartActions}><slot name=${SLOTS.headerActionsStart} @slotchange=${this.handleHeaderActionsStartSlotChange}></slot></div>`);
  }
  renderHeaderActionsEnd() {
    ...
    const collapseNode = collapsible ? (0,lit/* html */.qy)`<calcite-action .ariaExpanded=${!collapsed} .ariaLabel=${collapse} .icon=${collapsed ? icons[0] : icons[1]} id=${IDS.collapse} @click=${this.collapse} .scale=${this.scale} .text=${collapse} title=${(collapsed ? expand : collapse) ?? lit/* nothing */.s6}></calcite-action>` : null;
    const closeNode = closable ? (0,lit/* html */.qy)`<calcite-action .ariaLabel=${close} .icon=${ICONS.close} id=${IDS.close} @click=${this.handleUserClose} .scale=${this.scale} .text=${close} title=${close ?? lit/* nothing */.s6}></calcite-action>` : null;
    const slotNode = (0,lit/* html */.qy)`<slot name=${SLOTS.headerActionsEnd} @slotchange=${this.handleHeaderActionsEndSlotChange}></slot>`;
    const showContainer = hasEndActions || collapseNode || closeNode || hasMenuItems;
    return (0,keyed/* keyed */.D)("header-actions-end", (0,lit/* html */.qy)`<div class=${(0,dist/* safeClassMap */.CP)({ [resources3_CSS.headerActionsEnd]: true, [resources3_CSS.headerActions]: true })} .hidden=${!showContainer}>${slotNode}${this.renderMenu()}${collapseNode}${closeNode}</div>`);
  }
  renderMenu() {
    const { hasMenuItems, messages, menuOpen, menuFlipPlacements, menuPlacement } = this;
    return (0,keyed/* keyed */.D)("menu", (0,lit/* html */.qy)`<calcite-action-menu .flipPlacements=${menuFlipPlacements ?? ["top", "bottom"]} .hidden=${!hasMenuItems} .label=${messages.options} .open=${menuOpen} .overlayPositioning=${this.overlayPositioning} .placement=${menuPlacement}><calcite-action class=${(0,dist/* safeClassMap */.CP)(resources3_CSS.menuAction)} .icon=${ICONS.menu} .scale=${this.scale} slot=${resources2.S.trigger} .text=${messages.options}></calcite-action><slot name=${SLOTS.headerMenuActions} @slotchange=${this.handleHeaderMenuActionsSlotChange}></slot></calcite-action-menu>`);
  }
  renderHeaderNode() {
    ...
    return (0,lit/* html */.qy)`<header class=${(0,dist/* safeClassMap */.CP)(resources3_CSS.header)} .hidden=${!(showHeaderContent || hasActionBar)}><div class=${(0,dist/* safeClassMap */.CP)({ [resources3_CSS.headerContainer]: true, [resources3_CSS.headerContainerBorderEnd]: hasActionBar })} .hidden=${!showHeaderContent}>${this.renderHeaderStartActions()}${this.renderHeaderSlottedContent()}${headerContentNode}${this.renderHeaderActionsEnd()}</div>${this.renderActionBar()}${this.renderContentTop()}</header>`;
  }
  renderFooterNode() {
    ...
    return (0,lit/* html */.qy)`<footer class=${(0,dist/* safeClassMap */.CP)(resources3_CSS.footer)} .hidden=${!showFooter}><div class=${(0,dist/* safeClassMap */.CP)(resources3_CSS.footerContent)} .hidden=${!hasFooterContent}><slot name=${SLOTS.footer} @slotchange=${this.handleFooterSlotChange}></slot></div><div class=${(0,dist/* safeClassMap */.CP)(resources3_CSS.footerStart)} .hidden=${hasFooterContent || !hasFooterStartContent}><slot name=${SLOTS.footerStart} @slotchange=${this.handleFooterStartSlotChange}></slot></div><div class=${(0,dist/* safeClassMap */.CP)(resources3_CSS.footerEnd)} .hidden=${hasFooterContent || !hasFooterEndContent}><slot name=${SLOTS.footerEnd} @slotchange=${this.handleFooterEndSlotChange}></slot></div><div class=${(0,dist/* safeClassMap */.CP)(resources3_CSS.footerActions)} .hidden=${hasFooterContent || !hasFooterActions}>${(0,keyed/* keyed */.D)("footer-actions-slot", (0,lit/* html */.qy)`<slot name=${SLOTS.footerActions} @slotchange=${this.handleFooterActionsSlotChange}></slot>`)}</div></footer>`;
  }
  renderContent() {
    return (0,lit/* html */.qy)`<div class=${(0,dist/* safeClassMap */.CP)(resources3_CSS.contentWrapper)} .hidden=${this.collapsible && this.collapsed} @scroll=${this.panelScrollHandler} ${(0,ref/* ref */.K)(this.setPanelScrollEl)}><slot></slot>${this.renderFab()}</div>`;
  }
  renderContentBottom() {
    return (0,lit/* html */.qy)`<div class=${(0,dist/* safeClassMap */.CP)(resources3_CSS.contentBottom)} .hidden=${!this.hasContentBottom}><slot name=${SLOTS.contentBottom} @slotchange=${this.contentBottomSlotChangeHandler}></slot></div>`;
  }
  renderContentTop() {
    return (0,lit/* html */.qy)`<div class=${(0,dist/* safeClassMap */.CP)(resources3_CSS.contentTop)} .hidden=${!this.hasContentTop}><slot name=${SLOTS.contentTop} @slotchange=${this.contentTopSlotChangeHandler}></slot></div>`;
  }
  renderFab() {
    return (0,lit/* html */.qy)`<div class=${(0,dist/* safeClassMap */.CP)(resources3_CSS.fabContainer)} .hidden=${!this.hasFab}><slot name=${SLOTS.fab} @slotchange=${this.handleFabSlotChange}></slot></div>`;
  }
  render() {
    const { disabled, loading, isClosed } = this;
    const panelNode = (0,lit/* html */.qy)`<article .ariaBusy=${loading} class=${(0,dist/* safeClassMap */.CP)(resources3_CSS.container)} .hidden=${isClosed} ${(0,ref/* ref */.K)(this.setContainerRef)}>${this.renderHeaderNode()}${this.renderContent()}${this.renderContentBottom()}${this.renderFooterNode()}${(0,keyed/* keyed */.D)("alerts", (0,lit/* html */.qy)`<slot name=${SLOTS.alerts} @slotchange=${this.handleAlertsSlotChange}></slot>`)}</article>`;
...
var useFocusTrap = __webpack_require__(86678);
...
class Dialog extends dist/* LitElement */.WF {
  ...
  static {
    this.styles = calcite_dialog_customElement_styles;
  }
  ...
  handleOpenedChange(value) {
    ...
    transitionEl.classList.toggle(customElement_CSS.openingActive, value);
  ...
  render() {
    ...
    return (0,lit/* html */.qy)`<div class=${(0,dist/* safeClassMap */.CP)({
      [customElement_CSS.container]: true,
      [customElement_CSS.containerOpen]: opened,
      [customElement_CSS.containerEmbedded]: this.embedded
    })}>${this.modal ? (0,lit/* html */.qy)`<calcite-scrim class=${(0,dist/* safeClassMap */.CP)(customElement_CSS.scrim)} @click=${this.handleOutsideClose}></calcite-scrim>` : null}<div .ariaDescription=${description} .ariaLabel=${heading} .ariaModal=${this.modal} class=${(0,dist/* safeClassMap */.CP)({
      [customElement_CSS.dialog]: true,
      [getDimensionClass("width", this.width, this.widthScale)]: !!(this.width || this.widthScale)
    })} @keydown=${this.handleKeyDown} role=dialog ${(0,ref/* ref */.K)(this.setTransitionEl)}>${assistiveText ? (0,keyed/* keyed */.D)("assistive-text", (0,lit/* html */.qy)`<div aria-live=polite class=${(0,dist/* safeClassMap */.CP)(customElement_CSS.assistiveText)}>${assistiveText}</div>`) : null}<slot name=${customElement_SLOTS.customContent}><slot name=${customElement_SLOTS.content}><calcite-panel .beforeClose=${this.beforeClose} class=${(0,dist/* safeClassMap */.CP)(customElement_CSS.panel)} .closable=${!this.closeDisabled} .closed=${!opened} .description=${description} .heading=${heading} .headingLevel=${this.headingLevel} .loading=${this.loading} .menuOpen=${this.menuOpen} .messageOverrides=${this.messageOverrides} @keydown=${this.handlePanelKeyDown} @calcitePanelClose=${this.handleInternalPanelCloseClick} @calcitePanelScroll=${this.handleInternalPanelScroll} .overlayPositioning=${this.overlayPositioning} .scale=${this.scale} ${(0,ref/* ref */.K)(this.panelEl)}><slot name=${customElement_SLOTS.actionBar} slot=${SLOTS.actionBar}></slot><slot name=${customElement_SLOTS.alerts} slot=${SLOTS.alerts}></slot><slot name=${customElement_SLOTS.headerActionsStart} slot=${SLOTS.headerActionsStart}></slot><slot name=${customElement_SLOTS.headerActionsEnd} slot=${SLOTS.headerActionsEnd}></slot><slot name=${customElement_SLOTS.headerContent} slot=${SLOTS.headerContent}></slot><slot name=${customElement_SLOTS.headerMenuActions} slot=${SLOTS.headerMenuActions}></slot><slot name=${customElement_SLOTS.fab} slot=${SLOTS.fab}></slot><slot name=${customElement_SLOTS.contentTop} slot=${SLOTS.contentTop}></slot><slot name=${customElement_SLOTS.contentBottom} slot=${SLOTS.contentBottom}></slot><slot name=${customElement_SLOTS.footerStart} slot=${SLOTS.footerStart}></slot><slot name=${customElement_SLOTS.footer} slot=${SLOTS.footer}></slot><slot name=${customElement_SLOTS.footerEnd} slot=${SLOTS.footerEnd}></slot><slot></slot></calcite-panel></slot></slot></div></div>`;
  }
}
