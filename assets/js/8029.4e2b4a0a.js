...
/* harmony import */ var _support_rasterDatasets_datasetUtils_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(28582);
...
*/
const l="Image Service",o="imagery-layer-save",m="imagery-layer-save-as",n="imagery-tile-layer-save",c="imagery-tile-layer-save-as",p="WCS",u="wcs-layer-save",g="wcs-layer-save-as";function v(e){if("imagery"===e.type||"wcs"===e.type)return{isValid:!0};const{raster:t}=e,a=(0,_support_rasterDatasets_datasetUtils_js__WEBPACK_IMPORTED_MODULE_2__/* .getPrimaryRasters */ .p)(t)[0];return{isValid:"RasterTileServer"===a?.datasetFormat&&("Raster"===a.tileType||"Map"===a.tileType),errorMessage:"imagery tile layer should be created from a tiled image service."}}function f(e){const t=e.layerJSON;return Promise.resolve(t&&Object.keys(t).length?t:null)}async function d(e,t){const{parsedUrl:r,title:l,fullExtent:o}=e;t.url=r.path,t.title||=l;try{t.extent=await (0,_portal_support_portalItemUtils_js__WEBPACK_IMPORTED_MODULE_1__/* .getWGS84ExtentForItem */ .sQ)(o)}catch{t.extent=void 0}(0,_portal_support_portalItemUtils_js__WEBPACK_IMPORTED_MODULE_1__/* .removeTypeKeyword */ .OM)(t,_portal_support_portalItemUtils_js__WEBPACK_IMPORTED_MODULE_1__/* .typeKeyword */ .mm.METADATA),(0,_portal_support_portalItemUtils_js__WEBPACK_IMPORTED_MODULE_1__/* .toggleTypeKeyword */ .Sm)(t,_portal_support_portalItemUtils_js__WEBPACK_IMPORTED_MODULE_1__/* .typeKeyword */ .mm.TILED_IMAGERY,"imagery-tile"===e.type)}async function I(t,r){const a="imagery"===t.type?o:"imagery-tile"===t.type?n:u,s="wcs"===t.type?p:l;return (0,_utils_js__WEBPACK_IMPORTED_MODULE_0__/* .save */ .UN)({layer:t,itemType:s,validateLayer:v,createItemData:f,errorNamePrefix:a},r)}async function T(e,r,a){const s="imagery"===e.type?m:"imagery-tile"===e.type?c:g,i="wcs"===e.type?p:l;return (0,_utils_js__WEBPACK_IMPORTED_MODULE_0__/* .saveAs */ .Uh)({layer:e,itemType:i,validateLayer:v,createItemData:f,errorNamePrefix:s,newItem:r,setItemProperties:d},a)}
