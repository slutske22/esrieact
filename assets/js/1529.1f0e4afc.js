...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  SceneLayerSnappingSource: () => (/* binding */ c)
});
...
// EXTERNAL MODULE: ../node_modules/@arcgis/core/views/3d/support/buffer/workerHelper.js
var workerHelper = __webpack_require__(27445);
...
See https://js.arcgis.com/4.28/esri/copyright.txt for details.
*/
class a extends WorkerHandle/* WorkerHandle */.B{constructor(e){super("EdgeProcessingWorker","extract",{extract:e=>[e.dataBuffer],extractComponentsEdgeLocations:e=>[e.dataBuffer],extractEdgeLocations:e=>[e.dataBuffer]},e)}async process(e,t,r){if(r)return (0,edgeProcessing/* extract */.o6)(e);const s=await this.invoke(new i(e),t);return this._unpackOutput(s)}async extractEdgeLocations(e,t){const r=await this.invokeMethod("extractEdgeLocations",new i(e),t);return (0,workerHelper/* unpackInterleavedBuffer */.s)(r)}async extractComponentsEdgeLocations(e,t){const r=await this.invokeMethod("extractComponentsEdgeLocations",new i(e),t);return (0,workerHelper/* unpackInterleavedBuffer */.s)(r)}_unpackOutput(e){return{regular:{instancesData:(0,workerHelper/* unpackInterleavedBuffer */.s)(e.regular.instancesData),lodInfo:{lengths:new Float32Array(e.regular.lodInfo.lengths)}},silhouette:{instancesData:(0,workerHelper/* unpackInterleavedBuffer */.s)(e.silhouette.instancesData),lodInfo:{lengths:new Float32Array(e.silhouette.lodInfo.lengths)}},averageEdgeLength:e.averageEdgeLength}}}class i{constructor(r){this.dataBuffer=r.data.buffer,this.writerSettings=r.writerSettings,this.skipDeduplicate=r.skipDeduplicate,this.indices=(0,typedArrayUtil/* isArray */.cy)(r.indices)?r.indices:r.indices.buffer,this.indicesType=(0,typedArrayUtil/* isArray */.cy)(r.indices)?"Array":(0,typedArrayUtil/* isUint32Array */.XJ)(r.indices)?"Uint32Array":"Uint16Array",this.indicesLength=r.indicesLength}}
...
// EXTERNAL MODULE: ../node_modules/@arcgis/core/views/interactive/snapping/candidates/VertexSnappingCandidate.js
var VertexSnappingCandidate = __webpack_require__(22970);
...
See https://js.arcgis.com/4.28/esri/copyright.txt for details.
*/
let p=class extends Accessor/* default */.A{constructor(e){super(e),this.availability=0,this._ids=new Set}destroy(){this._workerHandle.destroy(),this._workerHandle=null}initialize(){this._workerHandle=new l(this.schedule,{fetchAllEdgeLocations:(e,t)=>this._fetchAllEdgeLocations(e,t)})}async fetchCandidates(e,t){const r=e.coordinateHelper,{point:o}=e,s=h;this.renderCoordsHelper.toRenderCoords(o,r.spatialReference,s);const n=e.distance,a="number"==typeof n?n:n.distance,d=await this._workerHandle.invoke({bounds:(0,sphere.f)(s[0],s[1],s[2],a),returnEdge:e.returnEdge,returnVertex:"none"!==e.vertexMode},t);return d.candidates.sort(((e,t)=>e.distance-t.distance)),d.candidates.map((e=>this._convertCandidate(r,e)))}async add(e,t){this._ids.add(e.id),await this._workerHandle.invokeMethod("add",e,t)}async remove(e,t){this._ids.delete(e.id),await this._workerHandle.invokeMethod("remove",e,t)}_convertCandidate(e,t){switch(t.type){case"edge":return new EdgeSnappingCandidate/* EdgeSnappingCandidate */.z({objectId:t.objectId,targetPoint:this._convertRenderCoordinate(e,t.target),edgeStart:this._convertRenderCoordinate(e,t.start),edgeEnd:this._convertRenderCoordinate(e,t.end),isDraped:!1});case"vertex":return new VertexSnappingCandidate/* VertexSnappingCandidate */.C({objectId:t.objectId,targetPoint:this._convertRenderCoordinate(e,t.target),isDraped:!1})}}_convertRenderCoordinate({spatialReference:e},t){const r=(0,vec3f64.c)();return this.renderCoordsHelper.fromRenderCoords(t,r,e),(0,normalizedPoint/* fromVec3 */._7)(r)}async _fetchAllEdgeLocations(e,t){const r=[],o=[];for(const{id:s,uid:n}of e.components)this._ids.has(s)&&r.push((async()=>{const e=await this.fetchEdgeLocations(s,t.signal),r=e.locations.buffer;return o.push(r),{id:s,uid:n,objectIds:e.objectIds,locations:r,origin:e.origin,type:e.type}})());return{result:{components:(await Promise.all(r)).filter((({id:e})=>this._ids.has(e)))},transferList:o}}};(0,tslib_es6._)([(0,property/* property */.MZ)({constructOnly:!0})],p.prototype,"renderCoordsHelper",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({constructOnly:!0})],p.prototype,"fetchEdgeLocations",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({constructOnly:!0})],p.prototype,"schedule",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({readOnly:!0})],p.prototype,"availability",void 0),p=(0,tslib_es6._)([(0,subclass/* subclass */.$)("esri.views.interactive.snapping.featureSources.sceneLayerSource.SceneLayerSnappingSourceWorker")],p);class l extends WorkerHandle/* WorkerHandle */.B{constructor(e,t){super("SceneLayerSnappingSourceWorker","fetchCandidates",{},e,{strategy:"dedicated",client:t})}}const h=(0,vec3f64.c)();
...
See https://js.arcgis.com/4.28/esri/copyright.txt for details.
*/
let I3SSnappingSource_p=class extends Accessor/* default */.A{get updating(){return this._updatingHandles.updating}constructor(e){super(e),this.availability=1,this._updatingHandles=new UpdatingHandles/* UpdatingHandles */.U,this._abortController=new AbortController}destroy(){this._tracker=(0,maybe/* removeMaybe */.xt)(this._tracker),this._abortController=(0,maybe/* abortMaybe */.DC)(this._abortController),this._updatingHandles.destroy()}initialize(){const{view:e}=this,r=e.resourceController;this._edgeWorker=new a(I3SSnappingSource_h(r)),this._workerHandle=new p({renderCoordsHelper:this.view.renderCoordsHelper,schedule:I3SSnappingSource_h(r),fetchEdgeLocations:async(e,r)=>{if(null==this._tracker)throw new Error("tracker-not-initialized");return this._tracker.fetchEdgeLocations(e,this._edgeWorker,r)}}),this._updatingHandles.addPromise(this._setupLayerView()),this.addHandles([(0,handleUtils/* destroyHandle */.DQ)(this._workerHandle),(0,handleUtils/* destroyHandle */.DQ)(this._edgeWorker)])}async fetchCandidates(e,r){return this._workerHandle.fetchCandidates(e,r)}refresh(){}async _setupLayerView(){if(this.destroyed)return;const e=this._abortController?.signal,r=await this.getLayerView();null==r||(0,promiseUtils/* isAborted */.G4)(e)||(this._tracker=r.trackSnappingSources({add:(r,t)=>{this._updatingHandles.addPromise(this._workerHandle.add({id:r,bounds:t},e))},remove:r=>{this._updatingHandles.addPromise(this._workerHandle.remove({id:r},e))}}))}};function I3SSnappingSource_h(e){return r=>e.immediate.schedule(r)}(0,tslib_es6._)([(0,property/* property */.MZ)({constructOnly:!0})],I3SSnappingSource_p.prototype,"getLayerView",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({constructOnly:!0})],I3SSnappingSource_p.prototype,"view",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({readOnly:!0})],I3SSnappingSource_p.prototype,"updating",null),(0,tslib_es6._)([(0,property/* property */.MZ)({readOnly:!0})],I3SSnappingSource_p.prototype,"availability",void 0),I3SSnappingSource_p=(0,tslib_es6._)([(0,subclass/* subclass */.$)("esri.views.interactive.snapping.featureSources.I3SSnappingSource")],I3SSnappingSource_p);
...
See https://js.arcgis.com/4.28/esri/copyright.txt for details.
*/
let c=class extends Accessor/* default */.A{get updating(){return this._i3sSources.some((e=>e.updating))}constructor(e){super(e),this.availability=1,this._i3sSources=[]}destroy(){this._i3sSources.forEach((e=>e.destroy())),this._i3sSources.length=0}initialize(){const{view:e}=this,r=this.layerSource.layer;this._i3sSources="building-scene"===r.type?this._getBuildingSceneI3SSources(e,r):[this._getSceneLayerI3SSource(e,r)]}async fetchCandidates(e,r){const s=await Promise.all(this._i3sSources.map((s=>s.fetchCandidates(e,r))));return (0,promiseUtils/* throwIfAborted */.Te)(r),s.flat()}refresh(){this._i3sSources.forEach((e=>e.refresh()))}_getBuildingSceneI3SSources(e,r){return r.allSublayers.toArray().map((s=>"building-component"===s.type?new I3SSnappingSource_p({getLayerView:async()=>(await e.whenLayerView(r)).whenSublayerView(s),view:e}):null)).filter(arrayUtils/* isSome */.Ru)}_getSceneLayerI3SSource(e,r){return new I3SSnappingSource_p({getLayerView:async()=>{const s=await e.whenLayerView(r);return"scene-layer-graphics-3d"===s.type?void 0:s},view:e})}};(0,tslib_es6._)([(0,property/* property */.MZ)({constructOnly:!0})],c.prototype,"layerSource",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({constructOnly:!0})],c.prototype,"view",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({readOnly:!0})],c.prototype,"updating",null),(0,tslib_es6._)([(0,property/* property */.MZ)({readOnly:!0})],c.prototype,"availability",void 0),c=(0,tslib_es6._)([(0,subclass/* subclass */.$)("esri.views.interactive.snapping.featureSources.SceneLayerSnappingSource")],c);
