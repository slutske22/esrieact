...
const Handle = /*@__PURE__*/ (0,client/* proxyCustomElement */.w$)(class extends client/* HTMLElement */.wt {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
    this.calciteHandleNudge = (0,client/* createEvent */.lh)(this, "calciteHandleNudge", 6);
    this.calciteInternalHandleChange = (0,client/* createEvent */.lh)(this, "calciteInternalHandleChange", 6);
...
const ListItem = /*@__PURE__*/ (0,client/* proxyCustomElement */.w$)(class extends client/* HTMLElement */.wt {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
    this.calciteListItemSelect = (0,client/* createEvent */.lh)(this, "calciteListItemSelect", 6);
    this.calciteListItemClose = (0,client/* createEvent */.lh)(this, "calciteListItemClose", 6);
    this.calciteInternalListItemSelect = (0,client/* createEvent */.lh)(this, "calciteInternalListItemSelect", 6);
    this.calciteInternalListItemActive = (0,client/* createEvent */.lh)(this, "calciteInternalListItemActive", 6);
    this.calciteInternalFocusPreviousItem = (0,client/* createEvent */.lh)(this, "calciteInternalFocusPreviousItem", 6);
    this.calciteInternalListItemChange = (0,client/* createEvent */.lh)(this, "calciteInternalListItemChange", 6);
    ...
    this.handleContentBottomSlotChange = (event) => {
      this.hasContentBottom = (0,dom.e)(event);
    };
  ...
  renderOpen() {
    ...
    return openable || parentListEl?.openable ? ((0,client.h)("td", { class: utils3.C.openContainer, key: "open-container", onClick: clickHandler }, (0,client.h)("calcite-icon", { icon: icon, key: icon, scale: "s" }))) : null;
  }
  renderActionsStart() {
  ...
  renderContentBottom() {
    ...
    return ((0,client.h)("div", { class: utils3.C.contentBottom, hidden: !hasContentBottom, style: { "--calcite-list-item-spacing-indent-multiplier": `${visualLevel}` } }, (0,client.h)("slot", { name: utils3.S.contentBottom, onSlotchange: this.handleContentBottomSlotChange })));
  }
  renderDefaultContainer() {
    return ((0,client.h)("div", { class: {
        [utils3.C.nestedContainer]: true,
        [utils3.C.nestedContainerHidden]: this.openable && !this.open,
  ...
  render() {
    ...
    return ((0,client.h)(client/* Host */.xr, null, (0,client.h)("tr", { "aria-expanded": openable ? (0,dom.t)(open) : null, "aria-label": label, "aria-level": level, "aria-posinset": setPosition, "aria-selected": (0,dom.t)(selected), "aria-setsize": setSize, class: {
