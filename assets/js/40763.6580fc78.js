...
class RadioButton extends dist/* LitElement */.WF {
  constructor() {
    super();
    this.checked = false;
    this.disabled = false;
    ...
    this.required = false;
    this.scale = "m";
    this.calciteInternalRadioButtonBlur = (0,dist/* createEvent */.lh)({ cancelable: false });
    this.calciteInternalRadioButtonCheckedChange = (0,dist/* createEvent */.lh)({ cancelable: false });
    this.calciteInternalRadioButtonFocus = (0,dist/* createEvent */.lh)({ cancelable: false });
    this.calciteRadioButtonChange = (0,dist/* createEvent */.lh)({ cancelable: false });
  ...
  handleKeyDown(event) {
    ...
    switch (adjustedKey) {
      ...
      case "ArrowUp":
        event.preventDefault();
        this.selectItem(radioButtons, (0,array.g)(Math.max(currentIndex - 1, -1), radioButtonsLength));
        return;
      case "ArrowRight":
      case "ArrowDown":
        event.preventDefault();
        this.selectItem(radioButtons, (0,array.g)(currentIndex + 1, radioButtonsLength));
        return;
      default:
        return;
    }
  ...
  render() {
    ...
    return (0,interactive.I)({ disabled: this.disabled, children: (0,lit/* html */.qy)`<div .ariaChecked=${this.checked} .ariaLabel=${(0,label.g)(this)} class=${(0,dist/* safeClassMap */.CP)(CSS.container)} @blur=${this.onContainerBlur} @focus=${this.onContainerFocus} role=radio tabindex=${tabIndex ?? lit/* nothing */.s6} ${(0,ref/* ref */.K)(this.setContainerEl)}><div class=${(0,dist/* safeClassMap */.CP)(CSS.radio)}></div></div>${(0,chunks_form.H)({ component: this })}` });
  }
}
(0,runtime.c)("calcite-radio-button", RadioButton);
