"use strict";
exports.id = 38131;
exports.ids = [38131,96446,13847,2921,78568,24293,93297,32524];
exports.modules = {
...
class FlowItem extends dist/* LitElement */.WF {
  constructor() {
    super(...arguments);
    ...
    this.calciteFlowItemBack = (0,dist/* createEvent */.lh)();
    this.calciteFlowItemClose = (0,dist/* createEvent */.lh)({ cancelable: false });
    this.calciteFlowItemScroll = (0,dist/* createEvent */.lh)({ cancelable: false });
    this.calciteFlowItemToggle = (0,dist/* createEvent */.lh)({ cancelable: false });
    this.calciteInternalFlowItemChange = (0,dist/* createEvent */.lh)({ cancelable: false });
  }
  static {
  ...
  renderBackButton() {
    ...
    return showBackButton ? (0,keyed/* keyed */.D)("flow-back-button", (0,lit/* html */.qy)`<calcite-action .ariaLabel=${label} class=${(0,dist/* safeClassMap */.CP)(CSS.backButton)} .icon=${icon} @click=${backButtonClick} scale=s slot=header-actions-start .text=${label} title=${label ?? lit/* nothing */.s6} ${(0,ref/* ref */.K)(this.setBackRef)}></calcite-action>`) : null;
  }
  render() {
    ...
    return (0,interactive.I)({ disabled, children: (0,lit/* html */.qy)`<calcite-panel .beforeClose=${beforeClose} .closable=${closable} .closed=${closed} .collapseDirection=${collapseDirection} .collapsed=${collapsed} .collapsible=${collapsible} .description=${description} .disabled=${disabled} .heading=${heading} .headingLevel=${headingLevel} .loading=${loading} .menuOpen=${menuOpen} .messageOverrides=${messages} @calcitePanelClose=${this.handleInternalPanelClose} @calcitePanelScroll=${this.handleInternalPanelScroll} @calcitePanelToggle=${this.handleInternalPanelToggle} .overlayPositioning=${overlayPositioning} .scale=${this.scale} ${(0,ref/* ref */.K)(this.setContainerRef)}>${this.renderBackButton()}<slot name=${SLOTS.actionBar} slot=${resources3.S.actionBar}></slot><slot name=${SLOTS.alerts} slot=${resources3.S.alerts}></slot><slot name=${SLOTS.headerActionsStart} slot=${resources3.S.headerActionsStart}></slot><slot name=${SLOTS.headerActionsEnd} slot=${resources3.S.headerActionsEnd}></slot><slot name=${SLOTS.headerContent} slot=${resources3.S.headerContent}></slot><slot name=${SLOTS.headerMenuActions} slot=${resources3.S.headerMenuActions}></slot><slot name=${SLOTS.fab} slot=${resources3.S.fab}></slot><slot name=${SLOTS.contentTop} slot=${resources3.S.contentTop}></slot><slot name=${SLOTS.contentBottom} slot=${resources3.S.contentBottom}></slot><slot name=${SLOTS.footerStart} slot=${resources3.S.footerStart}></slot><slot name=${SLOTS.footer} slot=${resources3.S.footer}></slot><slot name=${SLOTS.footerEnd} slot=${resources3.S.footerEnd}></slot><slot name=${SLOTS.footerActions} slot=${resources3.S.footerActions}></slot><slot></slot></calcite-panel>` });
  }
}
(0,runtime.c)("calcite-flow-item", FlowItem);


;// ../node_modules/@esri/calcite-components/dist/components/calcite-flow-item/index.js
