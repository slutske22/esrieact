...
class Flow extends dist/* LitElement */.WF {
  ...
  async handleFlowDirectionChange(flowDirection) {
    ...
    await (0,dom.z)(this.frameEl, flowDirection === "retreating" ? "calcite-frame-retreat" : "calcite-frame-advance");
  ...
  render() {
    ...
    return (0,lit/* html */.qy)`<div class=${(0,dist/* safeClassMap */.CP)(frameDirectionClasses)} ${(0,ref/* ref */.K)(this.setFrameEl)}><slot></slot></div>`;
  }
}
(0,runtime.c)("calcite-flow", Flow);
