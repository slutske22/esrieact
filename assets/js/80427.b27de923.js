...
See https://js.arcgis.com/4.33/esri/copyright.txt for details.
*/
let r;function o(){return!!r&&(0,_chunks_pe_js__WEBPACK_IMPORTED_MODULE_0__.i)()}async function i(){if(!o()){const[n,o]=await Promise.all([__webpack_require__.e(/* import() */ 46811).then(__webpack_require__.bind(__webpack_require__, 46811)),__webpack_require__.e(/* import() */ 57592).then(__webpack_require__.bind(__webpack_require__, 57592)).then((e=>e.aG)).then((({injectPe:e})=>e)),(0,_chunks_pe_js__WEBPACK_IMPORTED_MODULE_0__.l)()]);r=new n.OperatorGeodeticArea,o(_chunks_pe_js__WEBPACK_IMPORTED_MODULE_0__.p)}}function s(e,t,n){return r.execute(e,t,n,null)}function a(){return r.supportsCurves()}
