...
See https://js.arcgis.com/4.33/esri/copyright.txt for details.
*/
function i(){return t??=(async()=>{const i=await __webpack_require__.e(/* import() */ 17919).then(__webpack_require__.bind(__webpack_require__, 17919)),t=await i.default({locateFile:i=>(0,assets/* getAssetUrl */.s)(`esri/libs/basisu/${i}`)});return t.initializeBasis(),t})(),t}let t;
...
See https://js.arcgis.com/4.33/esri/copyright.txt for details.
*/
function e(){return r??=(async()=>{const e=await __webpack_require__.e(/* import() */ 38901).then(__webpack_require__.bind(__webpack_require__, 38901));return await e.default({locateFile:e=>(0,assets/* getAssetUrl */.s)(`esri/libs/dxtEncoder/${e}`)})})(),r}let r;
