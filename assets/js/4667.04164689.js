...
/* harmony export */ });
/* harmony import */ var _stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(36705);
...
/* harmony import */ var _locale_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(52572);
/* harmony import */ var _t9n_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(49263);
/* harmony import */ var _Heading_js__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(29430);
/* harmony import */ var _loadable_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(82850);
/* harmony import */ var _openCloseComponent_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(43301);
/* harmony import */ var _action_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(428);
/* harmony import */ var _action_menu_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(34437);
/* harmony import */ var _handle_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(60624);
/* harmony import */ var _icon_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(70999);
/* harmony import */ var _loader_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(48877);
/* harmony import */ var _popover_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(5650);
/* harmony import */ var _scrim_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(7338);
/*!
 * All material copyright ESRI, All Rights Reserved, unless otherwise specified.
 * See https://github.com/Esri/calcite-design-system/blob/main/LICENSE.md for details.
 * v1.11.0
...
const Block = /*@__PURE__*/ (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__/* .proxyCustomElement */ .w$)(class extends _stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__/* .HTMLElement */ .wt {
  constructor() {
    super();
    this.__registerHost();
    this.__attachShadow();
    this.calciteBlockBeforeClose = (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__/* .createEvent */ .lh)(this, "calciteBlockBeforeClose", 6);
    this.calciteBlockBeforeOpen = (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__/* .createEvent */ .lh)(this, "calciteBlockBeforeOpen", 6);
    this.calciteBlockClose = (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__/* .createEvent */ .lh)(this, "calciteBlockClose", 6);
    this.calciteBlockOpen = (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__/* .createEvent */ .lh)(this, "calciteBlockOpen", 6);
    this.calciteBlockToggle = (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__/* .createEvent */ .lh)(this, "calciteBlockToggle", 6);
  ...
  openHandler() {
    (0,_openCloseComponent_js__WEBPACK_IMPORTED_MODULE_14__.o)(this);
  }
  onMessagesChange() {
    /* wired up by t9n util */
  }
  ...
  renderScrim() {
    const { loading } = this;
    const defaultSlot = (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__.h)("slot", null);
    return [loading ? (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__.h)("calcite-scrim", { loading: loading }) : null, defaultSlot];
  }
  renderIcon() {
    const { loading, messages, status } = this;
    const hasSlottedIcon = !!(0,_dom_js__WEBPACK_IMPORTED_MODULE_1__.g)(this.el, SLOTS.icon);
    return loading ? ((0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__.h)("div", { class: CSS.icon, key: "loader" }, (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__.h)("calcite-loader", { inline: true, label: messages.loading }))) : !!status ? ((0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__.h)("div", { class: CSS.icon, key: "status-icon" }, (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__.h)("calcite-icon", { class: {
        [CSS.statusIcon]: true,
        [CSS.valid]: status == "valid",
        [CSS.invalid]: status == "invalid",
      }, icon: ICONS[status], scale: "s" }))) : hasSlottedIcon ? ((0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__.h)("div", { class: CSS.icon, key: "icon-slot" }, (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__.h)("slot", { key: "icon-slot", name: SLOTS.icon }))) : null;
  }
  renderTitle() {
    const { heading, headingLevel, description } = this;
    return heading || description ? ((0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__.h)("div", { class: CSS.title }, (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__.h)(_Heading_js__WEBPACK_IMPORTED_MODULE_15__.H, { class: CSS.heading, level: headingLevel }, heading), description ? (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__.h)("div", { class: CSS.description }, description) : null)) : null;
  }
  render() {
    const { collapsible, el, loading, open, messages } = this;
    const toggleLabel = open ? messages.collapse : messages.expand;
    const headerContent = ((0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__.h)("header", { class: CSS.header, id: IDS.header }, this.renderIcon(), this.renderTitle()));
    ...
    const headerNode = ((0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__.h)("div", { class: CSS.headerContainer }, this.dragHandle ? (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__.h)("calcite-handle", null) : null, collapsible ? ((0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__.h)("button", { "aria-controls": IDS.content, "aria-describedby": IDS.header, "aria-expanded": collapsible ? (0,_dom_js__WEBPACK_IMPORTED_MODULE_1__.t)(open) : null, class: CSS.toggle, id: IDS.toggle, onClick: this.onHeaderClick, title: toggleLabel }, headerContent, (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__.h)("calcite-icon", { "aria-hidden": "true", class: CSS.toggleIcon, icon: collapseIcon, scale: "s" }))) : (headerContent), hasControl ? ((0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__.h)("div", { class: CSS.controlContainer }, (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__.h)("slot", { name: SLOTS.control }))) : null, hasMenuActions ? ((0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__.h)("calcite-action-menu", { label: messages.options }, (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__.h)("slot", { name: SLOTS.headerMenuActions }))) : null));
    return ((0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__.h)(_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__/* .Host */ .xr, null, (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__.h)("article", { "aria-busy": (0,_dom_js__WEBPACK_IMPORTED_MODULE_1__.t)(loading), class: {
        [CSS.container]: true,
      } }, headerNode, (0,_stencil_core_internal_client_index_js__WEBPACK_IMPORTED_MODULE_13__.h)("section", { "aria-labelledby": IDS.toggle, class: CSS.content, hidden: !open, id: IDS.content,
      // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
