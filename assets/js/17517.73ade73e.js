...
/* harmony import */ var _geometry_operators_gx_operatorGeodeticArea_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(25363);
...
/* harmony export */ });
/* harmony import */ var _core_unitUtils_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(5262);
/* harmony import */ var _gx_operatorGeodeticArea_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(25363);
/* harmony import */ var _support_geodeticCurveType_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(65897);
/* harmony import */ var _chunks_geodeticAreaOperator_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(38137);
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.33/esri/copyright.txt for details.
*/
...
See https://js.arcgis.com/4.33/esri/copyright.txt for details.
*/
let r;function o(){return!!r&&(0,_chunks_pe_js__WEBPACK_IMPORTED_MODULE_0__.i)()}async function i(){if(!o()){const[n,o]=await Promise.all([__webpack_require__.e(/* import() */ 96133).then(__webpack_require__.bind(__webpack_require__, 96133)),__webpack_require__.e(/* import() */ 45262).then(__webpack_require__.bind(__webpack_require__, 45262)).then((e=>e.aG)).then((({injectPe:e})=>e)),(0,_chunks_pe_js__WEBPACK_IMPORTED_MODULE_0__.l)()]);r=new n.OperatorGeodeticArea,o(_chunks_pe_js__WEBPACK_IMPORTED_MODULE_0__.p)}}function s(e,t,n){return r.execute(e,t,n,null)}function a(){return r.supportsCurves()}
