...
See https://js.arcgis.com/4.33/esri/copyright.txt for details.
*/
const l=Symbol(),u=u=>{let y=class extends u{constructor(){super(...arguments),this.layerViews=new Collection/* default */.A,this._debouncedUpdate=(0,promiseUtils/* debounce */.sg)((async()=>{const{layer:e,parent:r}=this,t=r?.footprintLayerView;let s=[];const i=this._createQuery();if(i&&t){const{features:r}=await t.queryFeatures(i);this.suspended||(s=r.map((r=>e.acquireLayer(r))))}this.removeHandles(l),this.addHandles(s,l)}))}get creatingLayerViews(){return this.view?.layerViewManager.isCreatingLayerViewsForLayer(this.layer)??!1}isUpdating(){return this.creatingLayerViews||this.layer.updating||this.layerViews.some((e=>e.updating))}enableLayerUpdates(){return (0,handleUtils/* handlesGroup */.vE)([this._updatingHandles.addWhen((()=>!1===this.parent?.footprintLayerView?.dataUpdating),(()=>this.updateLayers())),this._updatingHandles.add((()=>[this.layer.maximumVisibleSublayers,this.layer.parent?.orderBy,this.parent?.footprintLayerView?.filter,this.parent?.footprintLayerView?.timeExtent,this.suspended]),(()=>this.updateLayers())),(0,handleUtils/* makeHandle */.hA)((()=>this.removeHandles(l)))])}updateLayers(){this.suspended?this.removeHandles(l):this._updatingHandles.addPromise((0,promiseUtils/* ignoreAbortErrors */.QZ)(this._debouncedUpdate()).catch((e=>{Logger/* default */.A.getLogger(this).error(e)})))}_createQuery(){const e=this.parent?.footprintLayerView,r=this.layer?.parent;if(!e||!r||r.destroyed)return null;const{layer:{maximumVisibleSublayers:t},view:{scale:s}}=this;if(!t)return null;const{itemTypeField:i,itemSourceField:a,itemNameField:o,minScaleField:d,maxScaleField:p,objectIdField:l,orderBy:u}=r,y=(0,sql/* sqlAnd */.mA)(`${d} IS NULL OR ${s} <= ${d} OR ${d} = 0`,`${p} IS NULL OR ${s} >= ${p}`),c=u?.find((e=>e.field&&!e.valueExpression)),m=e.createQuery();if(m.returnGeometry=!1,m.num=t,m.outFields=[l,a,o],m.where=(0,sql/* sqlAnd */.mA)(m.where,y),null!=this.unsupportedItemTypes){const e=`${i} NOT IN (${this.unsupportedItemTypes.map((e=>`'${e}'`))})`;m.where=(0,sql/* sqlAnd */.mA)(m.where,e)}return c?.field&&(m.orderByFields=[`${c.field} ${"descending"===c.order?"DESC":"ASC"}`],m.outFields.push(c.field)),m}};return (0,tslib_es6._)([(0,property/* property */.MZ)({readOnly:!0})],y.prototype,"creatingLayerViews",null),(0,tslib_es6._)([(0,property/* property */.MZ)()],y.prototype,"layer",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)()],y.prototype,"layerViews",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({readOnly:!0})],y.prototype,"unsupportedItemTypes",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)()],y.prototype,"parent",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({readOnly:!0})],y.prototype,"isUpdating",null),y=(0,tslib_es6._)([(0,subclass/* subclass */.$)("esri.views.layers.CatalogDynamicGroupLayerView")],y),y};
...
See https://js.arcgis.com/4.33/esri/copyright.txt for details.
*/
let i=class extends(u((0,LayerView2D/* LayerView2DMixin */.e)(LayerView/* default */.A))){constructor(){super(...arguments),this.unsupportedItemTypes=["Scene Service"],this.layerViews=new Collection/* default */.A}attach(){this.addAttachHandles([this.layerViews.on("after-changes",(()=>this._updateStageChildren())),this.enableLayerUpdates()])}detach(){this.container.removeAllChildren()}update(e){this.updateLayers()}viewChange(){}moveEnd(){this.requestUpdate()}_updateStageChildren(){this.container.removeAllChildren(),this.layerViews.forEach(((e,r)=>this.container.addChildAt(e.container,r)))}};i=(0,tslib_es6._)([(0,subclass/* subclass */.$)("esri.views.2d.layers.CatalogDynamicGroupLayerView2D")],i);const c=i;
