...
// EXPORTS
__webpack_require__.d(__webpack_exports__, {
  RadioButtonGroup: () => (/* reexport */ RadioButtonGroup)
});
...
class RadioButtonGroup extends dist/* LitElement */.WF {
  constructor() {
    ...
    this.status = "idle";
    this.calciteRadioButtonGroupChange = (0,dist/* createEvent */.lh)({ cancelable: false });
    this.listen("calciteRadioButtonChange", this.radioButtonChangeHandler);
  }
  static {
    this.properties = { radioButtons: [16, {}, { state: true }], disabled: [7, {}, { reflect: true, type: Boolean }], layout: [3, {}, { reflect: true }], name: [3, {}, { reflect: true }], required: [7, {}, { reflect: true, type: Boolean }], scale: [3, {}, { reflect: true }], selectedItem: [0, {}, { attribute: false }], status: [3, {}, { reflect: true }], validationIcon: [3, { converter: dist/* stringOrBoolean */.pf }, { reflect: true }], validationMessage: 1 };
  }
  static {
    this.styles = styles;
  }
  async setFocus() {
    ...
    if (this.selectedItem && !this.selectedItem.disabled) {
      (0,dom.h)(this.selectedItem);
    }
    if (this.radioButtons.length > 0) {
      (0,dom.h)(this.getFocusableRadioButton());
    }
  }
  connectedCallback() {
    super.connectedCallback();
  ...
  render() {
    ...
    return (0,lit/* html */.qy)`<div aria-errormessage=${IDS.validationMessage} .ariaInvalid=${this.status === "invalid"} class=${(0,dist/* safeClassMap */.CP)(CSS.itemWrapper)}><slot></slot></div>${this.validationMessage && this.status === "invalid" ? (0,Validation.V)({ icon: this.validationIcon, id: IDS.validationMessage, message: this.validationMessage, scale: this.scale, status: this.status }) : null}`;
  }
}
(0,runtime.c)("calcite-radio-button-group", RadioButtonGroup);


;// ../node_modules/@esri/calcite-components/dist/components/calcite-radio-button-group/index.js
