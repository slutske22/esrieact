...
class Checkbox extends dist/* LitElement */.WF {
  constructor() {
    super();
    ...
    this.toggleEl = (0,ref/* createRef */._)();
    this.checked = false;
    this.disabled = false;
    this.hovered = false;
    ...
    this.calciteCheckboxChange = (0,dist/* createEvent */.lh)({ cancelable: false });
    this.calciteInternalCheckboxBlur = (0,dist/* createEvent */.lh)({ cancelable: false });
    this.calciteInternalCheckboxFocus = (0,dist/* createEvent */.lh)({ cancelable: false });
  ...
  render() {
    const rtl = (0,dom.g)(this.el) === "rtl";
    return (0,interactive.I)({ disabled: this.disabled, children: (0,lit_html/* html */.qy)`<div .ariaChecked=${this.checked} .ariaLabel=${(0,label.g)(this)} class=${(0,dist/* safeClassMap */.CP)({
      [CSS.toggle]: true,
      [runtime.C.rtl]: rtl
    })} @blur=${this.onToggleBlur} @focus=${this.onToggleFocus} role=checkbox tabindex=${(this.disabled ? void 0 : 0) ?? dist/* nothing */.s6} ${(0,ref/* ref */.K)(this.toggleEl)}><svg aria-hidden=true class=${(0,dist/* safeClassMap */.CP)(CSS.check)} viewBox="0 0 16 16">${(0,lit_html/* svg */.JW)`<path d=${this.getPath() ?? dist/* nothing */.s6} />`}</svg><slot></slot></div>${(0,chunks_form.H)({ component: this })}` });
  }
}
(0,runtime.c)("calcite-checkbox", Checkbox);


;// ../node_modules/@esri/calcite-components/dist/components/calcite-checkbox/index.js
