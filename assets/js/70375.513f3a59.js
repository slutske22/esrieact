...
class Chip extends dist/* LitElement */.WF {
  constructor() {
    super();
    ...
    this.calciteChipClose = (0,dist/* createEvent */.lh)({ cancelable: false });
    this.calciteChipSelect = (0,dist/* createEvent */.lh)({ cancelable: false });
    this.calciteInternalChipKeyEvent = (0,dist/* createEvent */.lh)({ cancelable: false });
    this.calciteInternalChipSelect = (0,dist/* createEvent */.lh)({ cancelable: false });
    this.calciteInternalSyncSelectedChips = (0,dist/* createEvent */.lh)({ cancelable: false });
  ...
  renderChipImage() {
    return (0,lit/* html */.qy)`<div class=${(0,dist/* safeClassMap */.CP)(CSS.imageContainer)}><slot name=${SLOTS.image} @slotchange=${this.handleSlotImageChange}></slot></div>`;
  }
  renderSelectionIcon() {
    ...
    })}>${icon ? (0,lit/* html */.qy)`<calcite-icon .icon=${icon} .scale=${(0,component.g)(this.scale)}></calcite-icon>` : null}</div>`;
  }
  renderCloseButton() {
    return (0,lit/* html */.qy)`<button .ariaLabel=${this.messages.dismissLabel} class=${(0,dist/* safeClassMap */.CP)(CSS.close)} @click=${this.close} @keydown=${this.closeButtonKeyDownHandler} .tabIndex=${this.disabled ? -1 : 0} ${(0,ref/* ref */.K)(this.closeButtonEl)}><calcite-icon .icon=${ICONS.close} .scale=${(0,component.g)(this.scale)}></calcite-icon></button>`;
  }
  renderIcon() {
    return (0,lit/* html */.qy)`<calcite-icon class=${(0,dist/* safeClassMap */.CP)(CSS.chipIcon)} .flipRtl=${this.iconFlipRtl} .icon=${this.icon} .scale=${(0,component.g)(this.scale)}></calcite-icon>`;
  }
  render() {
    const { disabled } = this;
    ...
    return (0,interactive.I)({ disabled, children: (0,lit/* html */.qy)`<div .ariaChecked=${this.selectionMode !== "none" && this.interactive ? this.selected : void 0} .ariaLabel=${this.label} class=${(0,dist/* safeClassMap */.CP)({
      [CSS.container]: true,
    ...
    })} @click=${this.handleEmittingEvent} .role=${role} .tabIndex=${disableInteraction ? -1 : 0} ${(0,ref/* ref */.K)(this.containerEl)}>${this.selectionMode !== "none" && this.renderSelectionIcon() || ""}${this.renderChipImage()}${this.icon && this.renderIcon() || ""}<span class=${(0,dist/* safeClassMap */.CP)(CSS.title)}><slot @slotchange=${this.handleDefaultSlotChange}></slot></span>${this.closable && this.renderCloseButton() || ""}</div>` });
  }
}
(0,runtime.c)("calcite-chip", Chip);


;// ../node_modules/@esri/calcite-components/dist/components/calcite-chip/index.js
