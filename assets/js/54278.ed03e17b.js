...
__webpack_require__.d(__webpack_exports__, {
  AutocompleteItem: () => (/* reexport */ AutocompleteItem)
});
...
function highlightText({ text, pattern }) {
  ...
  if (parts.length > 1) {
    parts[1] = (0,lit_html/* html */.qy)`<mark class=${(0,dist/* safeClassMap */.CP)(CSS.textMatch)}>${parts[1]}</mark>`;
  }
  return parts;
}
...
class AutocompleteItem extends dist/* LitElement */.WF {
  constructor() {
    super(...arguments);
    this.active = false;
    this.disabled = false;
    this.guid = `autocomplete-item-${(0,guid.g)()}`;
    this.scale = "m";
    this.calciteInternalAutocompleteItemSelect = (0,dist/* createEvent */.lh)({ cancelable: false });
  }
  static {
  ...
  render() {
    ...
    return (0,interactive.I)({ disabled, children: (0,lit_html/* html */.qy)`<div class=${(0,dist/* safeClassMap */.CP)({
      ...
      [customElement_CSS.containerActive]: active && !disabled,
      [customElement_CSS.scale(this.scale)]: true
    })} @click=${this.handleClick}>${this.renderIcon("start")}<slot name=${SLOTS.contentStart}></slot><div class=${(0,dist/* safeClassMap */.CP)(customElement_CSS.contentCenter)}><div class=${(0,dist/* safeClassMap */.CP)(customElement_CSS.heading)}>${highlightText({
      text: heading,
      pattern: inputValueMatchPattern
    })}</div><div class=${(0,dist/* safeClassMap */.CP)(customElement_CSS.description)}>${highlightText({
      text: description,
      pattern: inputValueMatchPattern
  ...
  renderIcon(position) {
    ...
    return icon ? (0,lit_html/* html */.qy)`<calcite-icon class=${(0,dist/* safeClassMap */.CP)(position === "start" ? customElement_CSS.iconStart : customElement_CSS.iconEnd)} .flipRtl=${iconFlipRtl === position || iconFlipRtl === "both"} .icon=${icon} .scale=${(0,component.g)(this.scale)}></calcite-icon>` : null;
  }
}
(0,runtime.c)("calcite-autocomplete-item", AutocompleteItem);


;// ../node_modules/@esri/calcite-components/dist/components/calcite-autocomplete-item/index.js
