...
var wfsUtils = __webpack_require__(29299);
...
See https://js.arcgis.com/4.28/esri/copyright.txt for details.
*/
let g=class extends Loadable/* default */.A{constructor(){super(...arguments),this._connection=null,this.capabilities=(0,clientSideDefaults/* createCapabilities */.f)(!1,!1),this.type="wfs",this.refresh=(0,promiseUtils/* debounce */.sg)((async e=>{await this.load();const{extent:t}=await this._connection.invoke("refresh",e);return t&&(this.sourceJSON.extent=t),{dataChanged:!0,updates:{extent:this.sourceJSON.extent}}}))}load(e){const t=null!=e?e.signal:null;return this.addResolvingPromise(this._startWorker({signal:t})),Promise.resolve(this)}destroy(){this._connection?.close(),this._connection=null}async openPorts(){return await this.load(),this._connection.openPorts()}async queryFeatures(e,t={}){await this.load(t);const r=await this._connection.invoke("queryFeatures",e?e.toJSON():null,t);return FeatureSet/* default */.A.fromJSON(r)}async queryFeaturesJSON(e,t={}){return await this.load(t),this._connection.invoke("queryFeatures",e?e.toJSON():null,t)}async queryFeatureCount(e,t={}){return await this.load(t),this._connection.invoke("queryFeatureCount",e?e.toJSON():null,t)}async queryObjectIds(e,t={}){return await this.load(t),this._connection.invoke("queryObjectIds",e?e.toJSON():null,t)}async queryExtent(e,t={}){await this.load(t);const r=await this._connection.invoke("queryExtent",e?e.toJSON():null,t);return{count:r.count,extent:Extent/* default */.A.fromJSON(r.extent)}}async querySnapping(e,t={}){return await this.load(t),this._connection.invoke("querySnapping",e,t)}async _createLoadOptions(e){const{url:r,customParameters:s,name:o,namespaceUri:a,fields:i,geometryType:n,swapXY:p}=this.layer,l="defaults"===this.layer.originOf("spatialReference")?void 0:this.layer.spatialReference;if(!r)throw new Error/* default */.A("wfs-layer:missing-url","WFSLayer must be created with a url");this.wfsCapabilities||(this.wfsCapabilities=await (0,wfsUtils/* getCapabilities */.Fu)(r,{customParameters:s,...e}));const f=["fields","geometryType","name","namespaceUri","swapXY"].some((e=>null==this.layer[e])),h=f?await (0,wfsUtils/* getWFSLayerInfo */.O8)(this.wfsCapabilities,o,a,{spatialReference:l,customParameters:s,signal:e?.signal}):{...(0,wfsUtils/* prepareWFSLayerFields */.YW)(i??[]),geometryType:n,name:o,namespaceUri:a,spatialReference:l,swapXY:p},w=(0,wfsUtils/* findFeatureType */.mG)(this.wfsCapabilities.readFeatureTypes(),h.name,h.namespaceUri),g=typeUtils/* featureGeometryTypeKebabDictionary */.g.toJSON(h.geometryType);return{customParameters:s,featureType:w,fields:h.fields?.map((e=>e.toJSON()))??[],geometryField:h.geometryField,geometryType:g,getFeatureUrl:this.wfsCapabilities.operations.GetFeature.url,getFeatureOutputFormat:this.wfsCapabilities.operations.GetFeature.outputFormat,objectIdField:h.objectIdField,spatialReference:h.spatialReference?.toJSON(),swapXY:!!h.swapXY}}async _startWorker(e){const[t,r]=await (0,promiseUtils/* eachAlways */.Lx)([this._createLoadOptions(e),(0,workers/* open */.ho)("WFSSourceWorker",{...e,strategy:(0,has/* default */.A)("feature-layers-workers")?"dedicated":"local",registryTarget:this})]),s=t.error||r.error||null,i=r.value||null;if(s)throw i&&i.close(),s;const n=t.value;this._connection=r.value;const c=(await this._connection.invoke("load",n,e)).extent;this.sourceJSON={dateFieldsTimeReference:{timeZoneIANA:timeZoneUtils/* utc */.n$},extent:c,fields:n.fields,geometryType:n.geometryType,objectIdField:n.objectIdField,geometryField:n.geometryField,drawingInfo:(0,clientSideDefaults/* createDrawingInfo */.F0)(n.geometryType),name:n.featureType.title,wfsInfo:{name:n.featureType.name,featureUrl:n.getFeatureUrl,maxFeatures:3e3,swapXY:n.swapXY,supportedSpatialReferences:n.featureType.supportedSpatialReferences,version:"2.0.0",wfsNamespace:n.featureType.namespaceUri}}}};(0,tslib_es6._)([(0,property/* property */.MZ)()],g.prototype,"capabilities",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({constructOnly:!0})],g.prototype,"layer",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)()],g.prototype,"sourceJSON",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)()],g.prototype,"type",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)()],g.prototype,"wfsCapabilities",void 0),g=(0,tslib_es6._)([(0,subclass/* subclass */.$)("esri.layers.graphics.sources.WFSSource")],g);
...
See https://js.arcgis.com/4.28/esri/copyright.txt for details.
*/
var B;const J=(0,fieldProperties/* defineFieldProperties */.p)();let M=B=class extends((0,OrderedLayer/* OrderedLayer */.f)((0,CustomParametersMixin/* CustomParametersMixin */.d)((0,FeatureReductionLayer/* FeatureReductionLayer */.J)((0,FeatureEffectLayer/* FeatureEffectLayer */.F)((0,BlendLayer/* BlendLayer */.d)((0,TemporalLayer/* TemporalLayer */.e)((0,RefreshableLayer/* RefreshableLayer */.J)((0,ScaleRangeLayer/* ScaleRangeLayer */.j)((0,OperationalLayer/* OperationalLayer */.q)((0,PortalLayer/* PortalLayer */.A)((0,MultiOriginJSONSupport/* MultiOriginJSONMixin */.P)(Layer/* default */.A)))))))))))){static fromWFSLayerInfo(e){const{customParameters:r,fields:t,geometryField:i,geometryType:o,name:s,namespaceUri:n,objectIdField:p,spatialReference:a,swapXY:l,url:d,wfsCapabilities:m}=e;return new B({customParameters:r,fields:t,geometryField:i,geometryType:o,name:s,namespaceUri:n,objectIdField:p,spatialReference:a,swapXY:l,url:d,wfsCapabilities:m})}constructor(e){super(e),this.copyright=null,this.customParameters=null,this.dateFieldsTimeZone=null,this.definitionExpression=null,this.displayField=null,this.elevationInfo=null,this.featureUrl=void 0,this.fields=null,this.fieldsIndex=null,this.fullExtent=null,this.geometryType=null,this.labelsVisible=!0,this.labelingInfo=null,this.legendEnabled=!0,this.objectIdField=null,this.operationalLayerType="WFS",this.maxFeatures=3e3,this.mode=0,this.name=null,this.namespaceUri=null,this.outFields=null,this.popupEnabled=!0,this.popupTemplate=null,this.screenSizePerspectiveEnabled=!0,this.source=new g({layer:this}),this.spatialReference=SpatialReference/* default */.A.WGS84,this.spatialReferences=[4326],this.swapXY=void 0,this.title="WFS",this.type="wfs",this.url=null,this.version=void 0}destroy(){this.source?.destroy()}load(e){return this.addResolvingPromise(this.loadFromPortal({supportedTypes:["WFS"]},e).then((()=>this.source.load(e))).then((()=>{this.read(this.source.sourceJSON,{origin:"service",url:this.parsedUrl}),this.revert(["objectIdField","fields","timeInfo","spatialReference","name","namespaceUri"],"service"),(0,fieldUtils/* fixRendererFields */.yp)(this.renderer,this.fieldsIndex),(0,fieldUtils/* fixTimeInfoFields */.sv)(this.timeInfo,this.fieldsIndex)}))),Promise.resolve(this)}get capabilities(){return this.source?.capabilities}get createQueryVersion(){return this.commitProperty("definitionExpression"),this.commitProperty("timeExtent"),this.commitProperty("timeOffset"),this.commitProperty("geometryType"),this.commitProperty("capabilities"),(this._get("createQueryVersion")||0)+1}get defaultPopupTemplate(){return this.createPopupTemplate()}writeFields(e,r,t){const i=e.filter((e=>e.name!==wfsUtils/* wfsOidFieldName */.i5));this.geometryField&&i.unshift(new Field/* default */.A({name:this.geometryField,alias:this.geometryField,type:"geometry"})),(0,object/* setDeepValue */.sM)(t,i.map((e=>e.toJSON())),r)}get parsedUrl(){return (0,urlUtils/* urlToObject */.An)(this.url)}set renderer(e){(0,fieldUtils/* fixRendererFields */.yp)(e,this.fieldsIndex),this._set("renderer",e)}get wfsCapabilities(){return this.source?.wfsCapabilities}set wfsCapabilities(e){this.source&&(this.source.wfsCapabilities=e)}createPopupTemplate(e){return (0,popupUtils/* createPopupTemplate */.tn)(this,e)}createQuery(){const e=new Query/* default */.A;e.returnGeometry=!0,e.outFields=["*"],e.where=this.definitionExpression||"1=1";const{timeOffset:r,timeExtent:t}=this;return e.timeExtent=null!=r&&null!=t?t.offset(-r.value,r.unit):t||null,e}getFieldDomain(e,r){return this.getField(e)?.domain}getField(e){return this.fieldsIndex?.get(e)}queryFeatures(e,r){return this.load().then((()=>this.source.queryFeatures(Query/* default */.A.from(e)||this.createQuery(),r))).then((e=>{if(e?.features)for(const r of e.features)r.layer=r.sourceLayer=this;return e}))}queryObjectIds(e,r){return this.load().then((()=>this.source.queryObjectIds(Query/* default */.A.from(e)||this.createQuery(),r)))}queryFeatureCount(e,r){return this.load().then((()=>this.source.queryFeatureCount(Query/* default */.A.from(e)||this.createQuery(),r)))}queryExtent(e,r){return this.load().then((()=>this.source.queryExtent(Query/* default */.A.from(e)||this.createQuery(),r)))}async hasDataChanged(){try{const{dataChanged:e,updates:r}=await this.source.refresh(this.customParameters);return null!=r&&this.read(r,{origin:"service",url:this.parsedUrl,ignoreDefaults:!0}),e}catch{}return!1}};(0,tslib_es6._)([(0,property/* property */.MZ)({readOnly:!0})],M.prototype,"capabilities",null),(0,tslib_es6._)([(0,property/* property */.MZ)({type:String})],M.prototype,"copyright",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({readOnly:!0})],M.prototype,"createQueryVersion",null),(0,tslib_es6._)([(0,property/* property */.MZ)({json:{name:"wfsInfo.customParameters",write:{overridePolicy:e=>({enabled:!!(e&&Object.keys(e).length>0),ignoreOrigin:!0})}}})],M.prototype,"customParameters",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)((0,timeZoneUtils/* timeZoneProperty */.P6)("dateFieldsTimeReference"))],M.prototype,"dateFieldsTimeZone",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({readOnly:!0})],M.prototype,"defaultPopupTemplate",null),(0,tslib_es6._)([(0,property/* property */.MZ)({type:String,json:{name:"layerDefinition.definitionExpression",write:{enabled:!0,allowNull:!0}}})],M.prototype,"definitionExpression",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:String})],M.prototype,"displayField",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)(commonProperties/* elevationInfo */.Yj)],M.prototype,"elevationInfo",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:String,readOnly:!0,json:{name:"wfsInfo.featureUrl",write:{ignoreOrigin:!0,isRequired:!0}}})],M.prototype,"featureUrl",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:[Field/* default */.A],json:{name:"layerDefinition.fields",write:{ignoreOrigin:!0,isRequired:!0},origins:{service:{name:"fields"}}}})],M.prototype,"fields",void 0),(0,tslib_es6._)([(0,writer/* writer */.K)("fields")],M.prototype,"writeFields",null),(0,tslib_es6._)([(0,property/* property */.MZ)(J.fieldsIndex)],M.prototype,"fieldsIndex",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:Extent/* default */.A,json:{name:"extent"}})],M.prototype,"fullExtent",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)()],M.prototype,"geometryField",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:String,json:{read:{source:"layerDefinition.geometryType",reader:typeUtils/* featureGeometryTypeKebabDictionary */.g.read},write:{target:"layerDefinition.geometryType",writer:typeUtils/* featureGeometryTypeKebabDictionary */.g.write,ignoreOrigin:!0},origins:{service:{read:typeUtils/* featureGeometryTypeKebabDictionary */.g.read}}}})],M.prototype,"geometryType",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:String})],M.prototype,"id",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)(commonProperties/* labelsVisible */.kF)],M.prototype,"labelsVisible",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:[LabelClass/* default */.A],json:{name:"layerDefinition.drawingInfo.labelingInfo",read:{reader:labelingInfo/* reader */.w},write:!0}})],M.prototype,"labelingInfo",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)(commonProperties/* legendEnabled */.fV)],M.prototype,"legendEnabled",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:["show","hide"]})],M.prototype,"listMode",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:String})],M.prototype,"objectIdField",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:["WFS"]})],M.prototype,"operationalLayerType",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:ensureType/* Integer */.jz,json:{name:"wfsInfo.maxFeatures",write:{ignoreOrigin:!0,isRequired:!0}}})],M.prototype,"maxFeatures",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:[0],readOnly:!0,json:{origins:{"web-map":{write:{ignoreOrigin:!0,isRequired:!0}}}}})],M.prototype,"mode",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:String,json:{name:"wfsInfo.name",write:{ignoreOrigin:!0,isRequired:!0}}})],M.prototype,"name",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:String,json:{name:"wfsInfo.wfsNamespace",write:{ignoreOrigin:!0,isRequired:!0}}})],M.prototype,"namespaceUri",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)(commonProperties/* opacityDrawingInfo */.Ih)],M.prototype,"opacity",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)(J.outFields)],M.prototype,"outFields",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({readOnly:!0})],M.prototype,"parsedUrl",null),(0,tslib_es6._)([(0,property/* property */.MZ)(commonProperties/* popupEnabled */.M6)],M.prototype,"popupEnabled",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:PopupTemplate/* default */.A,json:{name:"popupInfo",write:!0}})],M.prototype,"popupTemplate",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({types:types/* rendererTypes */.H,json:{origins:{service:{name:"drawingInfo.renderer"},"web-scene":{types:types/* webSceneRendererTypes */.X,name:"layerDefinition.drawingInfo.renderer",write:!0}},name:"layerDefinition.drawingInfo.renderer",write:{ignoreOrigin:!0}}})],M.prototype,"renderer",null),(0,tslib_es6._)([(0,property/* property */.MZ)(commonProperties/* screenSizePerspectiveEnabled */.PY)],M.prototype,"screenSizePerspectiveEnabled",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({readOnly:!0})],M.prototype,"source",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:SpatialReference/* default */.A,json:{name:"layerDefinition.spatialReference",write:{ignoreOrigin:!0,isRequired:!0},origins:{service:{name:"extent.spatialReference"}}}})],M.prototype,"spatialReference",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({readOnly:!0,type:[ensureType/* Integer */.jz],json:{name:"wfsInfo.supportedSpatialReferences",write:{ignoreOrigin:!0,isRequired:!0}}})],M.prototype,"spatialReferences",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:Boolean,value:!1,json:{name:"wfsInfo.swapXY",write:{ignoreOrigin:!0,isRequired:!0}}})],M.prototype,"swapXY",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({json:{write:{ignoreOrigin:!0,isRequired:!0},origins:{service:{name:"name"}}}})],M.prototype,"title",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({json:{read:!1},readOnly:!0})],M.prototype,"type",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)(commonProperties/* url */.OZ)],M.prototype,"url",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:String,readOnly:!0,json:{name:"wfsInfo.version",write:{ignoreOrigin:!0,isRequired:!0}}})],M.prototype,"version",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)()],M.prototype,"wfsCapabilities",null),M=B=(0,tslib_es6._)([(0,subclass/* subclass */.$)("esri.layers.WFSLayer")],M);const Z=M;
...
/* harmony export */   UH: () => (/* binding */ ae),
/* harmony export */   YW: () => (/* binding */ q),
/* harmony export */   i5: () => (/* binding */ S),
/* harmony export */   mG: () => (/* binding */ V),
/* harmony export */   x$: () => (/* binding */ B)
/* harmony export */ });
/* unused harmony exports describeFeatureType, getFeatureCount, getFeatureTypeInfo, parseDescribeFeatureTypeResponse, parseGetCapabilitiesResponse */
...
/* harmony import */ var _core_iteratorUtils_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(20092);
/* harmony import */ var _core_urlUtils_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(20909);
/* harmony import */ var _geometry_projection_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(13484);
...
/* harmony import */ var _graphics_sources_geojson_geojson_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(11984);
/* harmony import */ var _xmlUtils_js__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(91690);
/* harmony import */ var _support_arcgisLayerUrl_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(16123);
/* harmony import */ var _support_Field_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(24738);
...
See https://js.arcgis.com/4.28/esri/copyright.txt for details.
*/
const T="xlink:href",F="2.0.0",S="__esri_wfs_id__",x="wfs-layer:getWFSLayerTypeInfo-error",C="wfs-layer:empty-service",E="wfs-layer:feature-type-not-found",R="wfs-layer:geojson-not-supported",k="wfs-layer:kvp-encoding-not-supported",P="wfs-layer:malformed-json",j="wfs-layer:unknown-geometry-type",N="wfs-layer:unknown-field-type",A="wfs-layer:unsupported-spatial-reference",G="wfs-layer:unsupported-wfs-version";async function v(t,r){const n=U((await (0,_request_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(t,{responseType:"text",query:{SERVICE:"WFS",REQUEST:"GetCapabilities",VERSION:F,...r?.customParameters},signal:r?.signal})).data);return L(t,n),n}function U(e){const t=ee(e);re(t),ne(t);const n=t.firstElementChild,a=(0,_core_iteratorUtils_js__WEBPACK_IMPORTED_MODULE_13__/* .cache */ .PP)(M(n));return{operations:D(n),get featureTypes(){return Array.from(a())},readFeatureTypes:a}}const I=new Set(["json","application/json","geojson","application/json; subtype=geojson"]);function D(e){let r=!1;const n={GetCapabilities:{url:""},DescribeFeatureType:{url:""},GetFeature:{url:"",outputFormat:null,supportsPagination:!1}};if((0,_xmlUtils_js__WEBPACK_IMPORTED_MODULE_14__/* .visitXML */ .p)(e,{OperationsMetadata:{Operation:e=>{switch(e.getAttribute("name")){case"GetCapabilities":return{DCP:{HTTP:{Get:e=>{n.GetCapabilities.url=e.getAttribute(T)}}}};case"DescribeFeatureType":return{DCP:{HTTP:{Get:e=>{n.DescribeFeatureType.url=e.getAttribute(T)}}}};case"GetFeature":return{DCP:{HTTP:{Get:e=>{n.GetFeature.url=e.getAttribute(T)}}},Parameter:e=>{if("outputFormat"===e.getAttribute("name"))return{AllowedValues:{Value:e=>{const t=e.textContent;t&&I.has(t.toLowerCase())&&(n.GetFeature.outputFormat=t)}}}}}}},Constraint:e=>{switch(e.getAttribute("name")){case"KVPEncoding":return{DefaultValue:e=>{r="true"===e.textContent.toLowerCase()}};case"ImplementsResultPaging":return{DefaultValue:e=>{n.GetFeature.supportsPagination="true"===e.textContent.toLowerCase()}}}}}}),!r)throw new _core_Error_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A(k,"WFS service doesn't support key/value pair (KVP) encoding");if(null==n.GetFeature.outputFormat)throw new _core_Error_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A(R,"WFS service doesn't support GeoJSON output format");return n}function L(e,t){(0,_core_urlUtils_js__WEBPACK_IMPORTED_MODULE_3__/* .isHTTPSProtocol */ .m3)(e)&&((0,_core_urlUtils_js__WEBPACK_IMPORTED_MODULE_3__/* .hasSameOrigin */ .FX)(e,t.operations.DescribeFeatureType.url,!0)&&(t.operations.DescribeFeatureType.url=(0,_core_urlUtils_js__WEBPACK_IMPORTED_MODULE_3__/* .toHTTPS */ .lM)(t.operations.DescribeFeatureType.url)),(0,_core_urlUtils_js__WEBPACK_IMPORTED_MODULE_3__/* .hasSameOrigin */ .FX)(e,t.operations.GetFeature.url,!0)&&(t.operations.GetFeature.url=(0,_core_urlUtils_js__WEBPACK_IMPORTED_MODULE_3__/* .toHTTPS */ .lM)(t.operations.GetFeature.url)))}function $(e){const t=parseInt(e.textContent?.match(/(?<wkid>\d+$)/i)?.groups?.wkid??"",10);if(!Number.isNaN(t))return t}function M(e){return (0,_xmlUtils_js__WEBPACK_IMPORTED_MODULE_14__/* .iterateXML */ .i)(e,{FeatureTypeList:{FeatureType:e=>{const t={typeName:"undefined:undefined",name:"",title:"",description:"",extent:null,namespacePrefix:"",namespaceUri:"",defaultSpatialReference:4326,supportedSpatialReferences:[]},r=new Set;return (0,_xmlUtils_js__WEBPACK_IMPORTED_MODULE_14__/* .visitXML */ .p)(e,{Name:e=>{const{name:r,prefix:n}=te(e.textContent);t.typeName=`${n}:${r}`,t.name=r,t.namespacePrefix=n,t.namespaceUri=e.lookupNamespaceURI(n)},Abstract:e=>{t.description=e.textContent},Title:e=>{t.title=e.textContent},WGS84BoundingBox:e=>{t.extent=O(e)},DefaultCRS:e=>{const n=$(e);n&&(t.defaultSpatialReference=n,r.add(n))},OtherCRS:e=>{const t=$(e);t&&r.add(t)}}),t.title||(t.title=t.name),r.add(4326),t.supportedSpatialReferences.push(...r),t}}})}function O(e){let t,r,n,a;for(const o of e.children)switch(o.localName){case"LowerCorner":[t,r]=o.textContent.split(" ").map((e=>Number.parseFloat(e)));break;case"UpperCorner":[n,a]=o.textContent.split(" ").map((e=>Number.parseFloat(e)))}return{xmin:t,ymin:r,xmax:n,ymax:a,spatialReference:_geometry_support_spatialReferenceUtils_js__WEBPACK_IMPORTED_MODULE_5__/* .WGS84 */ .w5}}function V(e,t,r){return (0,_core_iteratorUtils_js__WEBPACK_IMPORTED_MODULE_13__/* .find */ .I6)(e,(e=>r?e.name===t&&e.namespaceUri===r:e.typeName===t||e.name===t))}async function W(e,t,r,n={}){const{featureType:a,extent:o}=await X(e,t,r,n),{spatialReference:i}=ae(e.operations.GetFeature.url,a,n.spatialReference),{fields:s,geometryType:p,swapXY:u,objectIdField:l,geometryField:c}=await Y(e,a,i,n);return{url:e.operations.GetCapabilities.url,name:a.name,namespaceUri:a.namespaceUri,fields:s,geometryField:c,geometryType:p,objectIdField:l,spatialReference:n.spatialReference??new _geometry_SpatialReference_js__WEBPACK_IMPORTED_MODULE_11__/* ["default"] */ .A({wkid:a.defaultSpatialReference}),extent:o,swapXY:u,wfsCapabilities:e,customParameters:n.customParameters}}async function X(e,r,n,a={}){const o=e.readFeatureTypes(),i=r?V(o,r,n):o.next().value,{spatialReference:u=new _geometry_SpatialReference_js__WEBPACK_IMPORTED_MODULE_11__/* ["default"] */ .A({wkid:i?.defaultSpatialReference})}=a;if(null==i)throw r?new _core_Error_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A(E,`The type '${r}' could not be found in the service`):new _core_Error_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A(C,"The service is empty");let c=new _geometry_Extent_js__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .A({...i.extent,spatialReference:_geometry_SpatialReference_js__WEBPACK_IMPORTED_MODULE_11__/* ["default"] */ .A.WGS84});if(!(0,_geometry_support_spatialReferenceUtils_js__WEBPACK_IMPORTED_MODULE_5__/* .equals */ .aI)(c.spatialReference,u))try{await (0,_geometry_projection_js__WEBPACK_IMPORTED_MODULE_4__.initializeProjection)(c.spatialReference,u,void 0,a),c=(0,_geometry_projection_js__WEBPACK_IMPORTED_MODULE_4__.project)(c,u)}catch{throw new _core_Error_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A(A,"Projection not supported")}return{extent:c,spatialReference:u,featureType:i}}async function Y(e,r,n,a={}){const{typeName:o}=r,[i,s]=await Promise.allSettled([_(e.operations.DescribeFeatureType.url,o,a),z(e,o,n,a)]),p=e=>new _core_Error_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A(x,`An error occurred while getting info about the feature type '${o}'`,{error:e});if("rejected"===i.status)throw p(i.reason);if("rejected"===s.status)throw p(s.reason);const{fields:u,errors:l}=i.value??{},c=i.value?.geometryType||s.value?.geometryType,m=s.value?.swapXY??!1;if(null==c)throw new _core_Error_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A(j,`The geometry type could not be determined for type '${o}`,{typeName:o,geometryType:c,fields:u,errors:l});return{...q(u??[]),geometryType:c,swapXY:m}}function q(e){const t=e.find((e=>"geometry"===e.type));let r=e.find((e=>"oid"===e.type));return e=e.filter((e=>"geometry"!==e.type)),r||(r=new _support_Field_js__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .A({name:S,type:"oid",alias:S}),e.unshift(r)),{geometryField:t?.name??null,objectIdField:r.name,fields:e}}async function z(t,r,n,a={}){let o,i=!1;const[s,p]=await Promise.all([B(t.operations.GetFeature.url,r,n,t.operations.GetFeature.outputFormat,{...a,count:1}),(0,_request_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(t.operations.GetFeature.url,{responseType:"text",query:K(r,n,void 0,{...a,count:1}),signal:a?.signal})]),u="FeatureCollection"===s.type&&s.features[0]?.geometry;if(u){let e;switch(o=_geometry_support_typeUtils_js__WEBPACK_IMPORTED_MODULE_6__/* .featureGeometryTypeKebabDictionary */ .g.fromJSON((0,_graphics_sources_geojson_geojson_js__WEBPACK_IMPORTED_MODULE_7__/* .getGeometryType */ .xD)(u.type)),u.type){case"Point":e=u.coordinates;break;case"LineString":case"MultiPoint":e=u.coordinates[0];break;case"MultiLineString":case"Polygon":e=u.coordinates[0][0];break;case"MultiPolygon":e=u.coordinates[0][0][0]}const t=/<[^>]*pos[^>]*> *(-?\d+(?:\.\d+)?) (-?\d+(?:\.\d+)?)/.exec(p.data);if(t){const r=e[0].toFixed(3),n=e[1].toFixed(3),a=parseFloat(t[1]).toFixed(3);r===parseFloat(t[2]).toFixed(3)&&n===a&&(i=!0)}}return{geometryType:o,swapXY:i}}async function _(t,r,n){return Q(r,(await (0,_request_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(t,{responseType:"text",query:{SERVICE:"WFS",REQUEST:"DescribeFeatureType",VERSION:F,TYPENAME:r,...n?.customParameters},signal:n?.signal})).data)}function Q(e,r){const{name:a}=te(e),o=ee(r);ne(o);const i=(0,_core_iteratorUtils_js__WEBPACK_IMPORTED_MODULE_13__/* .find */ .I6)((0,_xmlUtils_js__WEBPACK_IMPORTED_MODULE_14__/* .iterateXML */ .i)(o.firstElementChild,{element:e=>({name:e.getAttribute("name"),typeName:te(e.getAttribute("type")).name})}),(({name:e})=>e===a));if(null!=i){const e=(0,_core_iteratorUtils_js__WEBPACK_IMPORTED_MODULE_13__/* .find */ .I6)((0,_xmlUtils_js__WEBPACK_IMPORTED_MODULE_14__/* .iterateXML */ .i)(o.firstElementChild,{complexType:e=>e}),(e=>e.getAttribute("name")===i.typeName));if(null!=e)return J(e)}throw new _core_Error_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A(E,`Type '${e}' not found in document`,{document:(new XMLSerializer).serializeToString(o)})}const H=new Set(["objectid","fid"]);function J(e){const r=[],n=[];let a;const o=(0,_xmlUtils_js__WEBPACK_IMPORTED_MODULE_14__/* .iterateXML */ .i)(e,{complexContent:{extension:{sequence:{element:e=>e}}}});for(const i of o){const o=i.getAttribute("name");if(!o)continue;let s,p;if(i.hasAttribute("type")?s=te(i.getAttribute("type")).name:(0,_xmlUtils_js__WEBPACK_IMPORTED_MODULE_14__/* .visitXML */ .p)(i,{simpleType:{restriction:e=>(s=te(e.getAttribute("base")).name,{maxLength:e=>{p=+e.getAttribute("value")}})}}),!s)continue;const u="true"===i.getAttribute("nillable");let l=!1;switch(s.toLowerCase()){case"integer":case"nonpositiveinteger":case"negativeinteger":case"long":case"int":case"short":case"byte":case"nonnegativeinteger":case"unsignedlong":case"unsignedint":case"unsignedshort":case"unsignedbyte":case"positiveinteger":n.push(new _support_Field_js__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .A({name:o,alias:o,type:"integer",nullable:u,length:(0,_support_fieldUtils_js__WEBPACK_IMPORTED_MODULE_10__/* .getFieldDefaultLength */ ._b)("integer")}));break;case"float":case"double":case"decimal":n.push(new _support_Field_js__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .A({name:o,alias:o,type:"double",nullable:u,length:(0,_support_fieldUtils_js__WEBPACK_IMPORTED_MODULE_10__/* .getFieldDefaultLength */ ._b)("double")}));break;case"boolean":case"string":case"gyearmonth":case"gyear":case"gmonthday":case"gday":case"gmonth":case"anyuri":case"qname":case"notation":case"normalizedstring":case"token":case"language":case"idrefs":case"entities":case"nmtoken":case"nmtokens":case"name":case"ncname":case"id":case"idref":case"entity":case"duration":case"time":n.push(new _support_Field_js__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .A({name:o,alias:o,type:"string",nullable:u,length:p??(0,_support_fieldUtils_js__WEBPACK_IMPORTED_MODULE_10__/* .getFieldDefaultLength */ ._b)("string")}));break;case"datetime":case"date":n.push(new _support_Field_js__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .A({name:o,alias:o,type:"date",nullable:u,length:p??(0,_support_fieldUtils_js__WEBPACK_IMPORTED_MODULE_10__/* .getFieldDefaultLength */ ._b)("date")}));break;case"pointpropertytype":a="point",l=!0;break;case"multipointpropertytype":a="multipoint",l=!0;break;case"curvepropertytype":case"multicurvepropertytype":case"multilinestringpropertytype":a="polyline",l=!0;break;case"surfacepropertytype":case"multisurfacepropertytype":case"multipolygonpropertytype":a="polygon",l=!0;break;case"geometrypropertytype":case"multigeometrypropertytype":l=!0,r.push(new _core_Error_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A(j,`geometry type '${s}' is not supported`,{type:(new XMLSerializer).serializeToString(e)}));break;default:r.push(new _core_Error_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A(N,`Unknown field type '${s}'`,{type:(new XMLSerializer).serializeToString(e)}))}l&&n.push(new _support_Field_js__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .A({name:o,alias:o,type:"geometry",nullable:u}))}for(const t of n)if("integer"===t.type&&!t.nullable&&H.has(t.name.toLowerCase())){t.type="oid";break}return{geometryType:a,fields:n,errors:r}}async function B(r,n,a,o,i){let{data:s}=await (0,_request_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(r,{responseType:"text",query:K(n,a,o,i),signal:i?.signal});s=s.replaceAll(/": +(-?\d+),(\d+)(,)?/g,'": $1.$2$3');try{return JSON.parse(s)}catch(p){throw new _core_Error_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A(P,"Error while parsing the response",{response:s,error:p})}}function K(e,t,r,n){const a="number"==typeof t?t:t.wkid;return{SERVICE:"WFS",REQUEST:"GetFeature",VERSION:F,TYPENAMES:e,OUTPUTFORMAT:r,SRSNAME:"EPSG:"+a,STARTINDEX:n?.startIndex,COUNT:n?.count,...n?.customParameters}}async function Z(t,r,n){const a=ee((await e(t,{responseType:"text",query:{SERVICE:"WFS",REQUEST:"GetFeature",VERSION:F,TYPENAMES:r,RESULTTYPE:"hits",...n?.customParameters},signal:n?.signal})).data);ne(a);const o=Number.parseFloat(a.firstElementChild.getAttribute("numberMatched"));return Number.isNaN(o)?0:o}function ee(e){return(new DOMParser).parseFromString(e.trim(),"text/xml")}function te(e){const[t,r]=e.split(":");return{prefix:r?t:"",name:r??t}}function re(e){const r=e.firstElementChild?.getAttribute("version");if(r&&r!==F)throw new _core_Error_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A(G,`Unsupported WFS version ${r}. Supported version: ${F}`)}function ne(e){let r="",n="";if((0,_xmlUtils_js__WEBPACK_IMPORTED_MODULE_14__/* .visitXML */ .p)(e.firstElementChild,{Exception:e=>(r=e.getAttribute("exceptionCode"),{ExceptionText:e=>{n=e.textContent}})}),r)throw new _core_Error_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A(`wfs-layer:${r}`,n)}function ae(e,t,r){const n={wkid:t.defaultSpatialReference},a=null!=r?.wkid?{wkid:r.wkid}:n;return{spatialReference:a,getFeatureSpatialReference:(0,_support_arcgisLayerUrl_js__WEBPACK_IMPORTED_MODULE_8__/* .isArcGISUrl */ .Fi)(e)||a.wkid&&t.supportedSpatialReferences.includes(a.wkid)?{wkid:a.wkid}:{wkid:t.defaultSpatialReference}}}
