"use strict";
exports.id = 62776;
exports.ids = [62776,96446,13847,78568,24293,93297,13406,16792,44490,32524];
exports.modules = {
...
class Block extends dist/* LitElement */.WF {
  constructor() {
    ...
    this.calciteBlockBeforeClose = (0,dist/* createEvent */.lh)({ cancelable: false });
    this.calciteBlockBeforeOpen = (0,dist/* createEvent */.lh)({ cancelable: false });
    this.calciteBlockClose = (0,dist/* createEvent */.lh)({ cancelable: false });
    this.calciteBlockOpen = (0,dist/* createEvent */.lh)({ cancelable: false });
    this.calciteBlockSortHandleBeforeClose = (0,dist/* createEvent */.lh)({ cancelable: false });
    this.calciteBlockSortHandleBeforeOpen = (0,dist/* createEvent */.lh)({ cancelable: false });
    this.calciteBlockSortHandleClose = (0,dist/* createEvent */.lh)({ cancelable: false });
    this.calciteBlockSortHandleOpen = (0,dist/* createEvent */.lh)({ cancelable: false });
    this.calciteBlockToggle = (0,dist/* createEvent */.lh)({ cancelable: false });
  }
  static {
  ...
  load() {
    if (!this.heading && !this.label) {
      logger.l.warn(`${this.el.tagName} is missing both heading & label. Please provide a heading or label for the component to be accessible.`);
    }
  }
  willUpdate(changes) {
    if (changes.has("expanded") && (this.hasUpdated || this.expanded !== false)) {
  ...
  renderScrim() {
    const { loading } = this;
    const defaultSlot = (0,lit/* html */.qy)`<slot></slot>`;
    return [loading ? (0,lit/* html */.qy)`<calcite-scrim .loading=${loading}></calcite-scrim>` : null, defaultSlot];
  }
  renderLoaderStatusIcon() {
    const { loading, messages, status } = this;
    return loading ? (0,keyed/* keyed */.D)("loader", (0,lit/* html */.qy)`<div class=${(0,dist/* safeClassMap */.CP)(CSS.icon)}><calcite-loader inline .label=${messages.loading}></calcite-loader></div>`) : status ? (0,keyed/* keyed */.D)("status-icon", (0,lit/* html */.qy)`<div class=${(0,dist/* safeClassMap */.CP)(CSS.icon)}><calcite-icon class=${(0,dist/* safeClassMap */.CP)({
      [CSS.statusIcon]: true,
      [CSS.valid]: status == "valid",
      [CSS.invalid]: status == "invalid"
    })} .icon=${ICONS[status]} scale=s></calcite-icon></div>`) : (0,keyed/* keyed */.D)("icon-slot", (0,lit/* html */.qy)`<div class=${(0,dist/* safeClassMap */.CP)(CSS.icon)} .hidden=${!this.hasIcon}>${(0,keyed/* keyed */.D)("icon-slot", (0,lit/* html */.qy)`<slot name=${SLOTS.icon} @slotchange=${this.iconSlotChangeHandler}></slot>`)}</div>`);
  }
  renderActionsEnd() {
    return (0,lit/* html */.qy)`<div class=${(0,dist/* safeClassMap */.CP)(CSS.actionsEnd)} .hidden=${!this.hasEndActions}><slot name=${SLOTS.actionsEnd} @slotchange=${this.actionsEndSlotChangeHandler}></slot></div>`;
  }
  renderContentStart() {
    return (0,lit/* html */.qy)`<div class=${(0,dist/* safeClassMap */.CP)(CSS.contentStart)} .hidden=${!this.hasContentStart}><slot name=${SLOTS.contentStart} @slotchange=${this.handleContentStartSlotChange}></slot></div>`;
  }
  renderTitle() {
    const { heading, headingLevel, description } = this;
    return heading || description ? (0,lit/* html */.qy)`<div class=${(0,dist/* safeClassMap */.CP)(CSS.title)}>${(0,Heading.H)({ class: CSS.heading, level: headingLevel, children: heading })}${description ? (0,lit/* html */.qy)`<div class=${(0,dist/* safeClassMap */.CP)(CSS.description)}>${description}</div>` : null}</div>` : null;
  }
  renderIcon(position) {
    ...
    return (0,keyed/* keyed */.D)(iconValue, (0,lit/* html */.qy)`<calcite-icon class=${(0,dist/* safeClassMap */.CP)(iconClass)} .flipRtl=${flipRtl} .icon=${iconValue} scale=s></calcite-icon>`);
  }
  render() {
    ...
    const headerContent = (0,lit/* html */.qy)`<header class=${(0,dist/* safeClassMap */.CP)({ [CSS.header]: true, [CSS.headerHasText]: !!(heading || description) })} id=${IDS.header}>${this.renderIcon("start")}${this.renderContentStart()}${this.renderLoaderStatusIcon()}${this.renderTitle()}</header>`;
    const collapseIcon = expanded ? ICONS.expanded : ICONS.collapsed;
    const headerNode = (0,lit/* html */.qy)`<div class=${(0,dist/* safeClassMap */.CP)(CSS.headerContainer)}>${this.dragHandle ? (0,lit/* html */.qy)`<calcite-sort-handle .disabled=${dragDisabled} .label=${heading || label} .moveToItems=${moveToItems} @calciteSortHandleBeforeClose=${this.handleSortHandleBeforeClose} @calciteSortHandleBeforeOpen=${this.handleSortHandleBeforeOpen} @calciteSortHandleClose=${this.handleSortHandleClose} @calciteSortHandleOpen=${this.handleSortHandleOpen} overlay-positioning=fixed .setPosition=${setPosition} .setSize=${setSize} ${(0,ref/* ref */.K)(this.setSortHandleEl)}></calcite-sort-handle>` : null}${collapsible ? (0,lit/* html */.qy)`<button aria-controls=${IDS.content} aria-describedby=${IDS.header} .ariaExpanded=${collapsible ? expanded : null} class=${(0,dist/* safeClassMap */.CP)(CSS.toggle)} id=${IDS.toggle} @click=${this.onHeaderClick} title=${toggleLabel ?? lit/* nothing */.s6}>${headerContent}<div class=${(0,dist/* safeClassMap */.CP)(CSS.iconEndContainer)}>${this.renderIcon("end")}<calcite-icon class=${(0,dist/* safeClassMap */.CP)(CSS.toggleIcon)} .icon=${collapseIcon} scale=s></calcite-icon></div></button>` : this.iconEnd ? (0,lit/* html */.qy)`<div>${headerContent}<div class=${(0,dist/* safeClassMap */.CP)(CSS.iconEndContainer)}>${this.renderIcon("end")}</div></div>` : headerContent}<div aria-labelledby=${IDS.header} class=${(0,dist/* safeClassMap */.CP)(CSS.controlContainer)} .hidden=${!this.hasControl}><slot name=${SLOTS.control} @slotchange=${this.controlSlotChangeHandler}></slot></div><calcite-action-menu .flipPlacements=${menuFlipPlacements ?? ["top", "bottom"]} .hidden=${!this.hasMenuActions} .label=${messages.options} .overlayPositioning=${this.overlayPositioning} .placement=${menuPlacement}><slot name=${SLOTS.headerMenuActions} @slotchange=${this.menuActionsSlotChangeHandler}></slot></calcite-action-menu>${this.renderActionsEnd()}</div>`;
    return (0,interactive.I)({ disabled: this.disabled, children: (0,lit/* html */.qy)`<article aria-label=${label ?? lit/* nothing */.s6} .ariaBusy=${loading} class=${(0,dist/* safeClassMap */.CP)({
      [CSS.container]: true
    })}>${headerNode}<section aria-labelledby=${IDS.toggle} class=${(0,dist/* safeClassMap */.CP)(CSS.content)} .hidden=${!expanded} id=${IDS.content}>${this.renderScrim()}</section></article>` });
  }
}
(0,runtime.c)("calcite-block", Block);


;// ../node_modules/@esri/calcite-components/dist/components/calcite-block/index.js
