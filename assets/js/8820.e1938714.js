...
See https://js.arcgis.com/4.28/esri/copyright.txt for details.
*/
let h=class extends Loadable/* default */.A{constructor(){super(...arguments),this.featureDefinition=null,this.type="ogc-feature"}load(e){return this.addResolvingPromise(this._loadOGCServices(this.layer,e)),this.when()}getSource(){const{featureDefinition:{collection:e,layerDefinition:t,spatialReference:s,supportedCrs:r},layer:{apiKey:o,customParameters:p,effectiveMaxRecordCount:i}}=this;return{type:"ogc-source",collection:e,layerDefinition:t,maxRecordCount:i,queryParameters:{apiKey:o,customParameters:p},spatialReference:s,supportedCrs:r}}queryExtent(e,t={}){return null}queryFeatureCount(e,t={}){return null}queryFeatures(e,t={}){return this.queryFeaturesJSON(e,t).then((e=>FeatureSet/* default */.A.fromJSON(e)))}queryFeaturesJSON(e,t={}){const s=this.getSource();return this.load(t).then((()=>(0,ogcFeatureUtils/* queryFeatureSetJSON */.bW)(s,e,t)))}queryObjectIds(e,t={}){return null}serviceSupportsSpatialReference(e){return!(!e.isWGS84&&!e.isWebMercator)||!!this.featureDefinition.supportedCrs[e.wkid]}_conformsToType(e,t){const s=new RegExp(`^${t}$`,"i");return e.conformsTo.some((e=>s.test(e)))??!1}_getCapabilities(e,t){return{analytics:{supportsCacheHint:!1},attachment:null,data:{isVersioned:!1,supportsAttachment:!1,supportsM:!1,supportsZ:e},metadata:{supportsAdvancedFieldProperties:!1},operations:{supportsCalculate:!1,supportsTruncate:!1,supportsValidateSql:!1,supportsAdd:!1,supportsDelete:!1,supportsEditing:!1,supportsChangeTracking:!1,supportsQuery:!1,supportsQueryAnalytics:!1,supportsQueryAttachments:!1,supportsQueryTopFeatures:!1,supportsResizeAttachments:!1,supportsSync:!1,supportsUpdate:!1,supportsExceedsLimitStatistics:!1,supportsAsyncConvert3D:!1},query:{maxRecordCount:t,maxRecordCountFactor:void 0,standardMaxRecordCount:void 0,supportsCacheHint:!1,supportsCentroid:!1,supportsDisjointSpatialRelationship:!1,supportsDistance:!1,supportsDistinct:!1,supportsExtent:!1,supportsFormatPBF:!1,supportsGeometryProperties:!1,supportsHavingClause:!1,supportsHistoricMoment:!1,supportsMaxRecordCountFactor:!1,supportsOrderBy:!1,supportsPagination:!1,supportsPercentileStatistics:!1,supportsQuantization:!1,supportsQuantizationEditMode:!1,supportsQueryByAnonymous:!1,supportsQueryByOthers:!1,supportsQueryGeometry:!1,supportsResultType:!1,supportsStandardizedQueriesOnly:!1,supportsTopFeaturesQuery:!1,supportsStatistics:!1,supportsSpatialAggregationStatistics:!1,supportedSpatialAggregationStatistics:{envelope:!1,centroid:!1,convexHull:!1},supportsDefaultSpatialReference:!1,supportsFullTextSearch:!1,supportsCompactGeometry:!1,supportsSqlExpression:!1,tileMaxRecordCount:void 0},queryRelated:{supportsCount:!1,supportsOrderBy:!1,supportsPagination:!1,supportsCacheHint:!1},queryTopFeatures:{supportsCacheHint:!1},editing:{supportsDeleteByAnonymous:!1,supportsDeleteByOthers:!1,supportsGeometryUpdate:!1,supportsGlobalId:!1,supportsReturnServiceEditsInSourceSpatialReference:!1,supportsRollbackOnFailure:!1,supportsUpdateByAnonymous:!1,supportsUpdateByOthers:!1,supportsUploadWithItemId:!1,supportsUpdateWithoutM:!1,supportsAsyncApplyEdits:!1,zDefault:void 0}}}_getMaxRecordCount(e){const t=e?.components?.parameters;return t?.limit?.schema?.maximum??t?.limitFeatures?.schema?.maximum}_getStorageSpatialReference(e){const t=e.storageCrs??ogcFeatureUtils/* crsDefault */.QE,s=(0,ogcFeatureUtils/* getSpatialReferenceWkid */.J0)(t);return null==s?SpatialReference/* default */.A.WGS84:new SpatialReference/* default */.A({wkid:s})}_getSupportedSpatialReferences(e,t){const s="#/crs",r=e.crs??[ogcFeatureUtils/* crsDefault */.QE],o=r.includes(s)?r.filter((e=>e!==s)).concat(t.crs??[]):r,p=/^http:\/\/www\.opengis.net\/def\/crs\/epsg\/.*\/3785$/i;return o.filter((e=>!p.test(e)))}async _loadOGCServices(e,s){const r=null!=s?s.signal:null,{apiKey:o,collectionId:p,customParameters:i,fields:y,geometryType:f,hasZ:h,objectIdField:S,timeInfo:C,url:R}=e,w={fields:y?.map((e=>e.toJSON())),geometryType:typeUtils/* typeKebabDictionary */.Y.toJSON(f),hasZ:h??!1,objectIdField:S,timeInfo:C?.toJSON()},x={apiKey:o,customParameters:i,signal:r},j=await (0,ogcFeatureUtils/* getServerLandingPage */.Ki)(R,x),[v,F]=await Promise.all([(0,ogcFeatureUtils/* getServerConformance */.Px)(j,x),(0,ogcFeatureUtils/* getServerCollections */.bV)(j,x)]);if(!this._conformsToType(v,"http://www.opengis.net/spec/ogcapi-features-1/1.0/conf/geojson"))throw new Error/* default */.A("ogc-feature-layer:no-geojson-support","Server does not support geojson");const O=F.collections.find((e=>e.id===p));if(!O)throw new Error/* default */.A("ogc-feature-layer:collection-not-found","Server does not contain the named collection");const D=this._conformsToType(v,"http://www.opengis.net/spec/ogcapi-features-1/1.0/conf/oas30")?await (0,ogcFeatureUtils/* getServerOpenApi */.GA)(j,x):null,T=await (0,ogcFeatureUtils/* getCollectionDefinition */.GL)(O,w,x),A=this._getMaxRecordCount(D),_=this._getCapabilities(T.hasZ,A),P=this._getStorageSpatialReference(O).toJSON(),b=this._getSupportedSpatialReferences(O,F),q=new RegExp(`^${ogcFeatureUtils/* crsPrefix */.vJ}`,"i"),E={};for(const t of b){const e=(0,ogcFeatureUtils/* getSpatialReferenceWkid */.J0)(t);null!=e&&(E[e]||(E[e]=t.replace(q,"")))}this.featureDefinition={capabilities:_,collection:O,layerDefinition:T,spatialReference:P,supportedCrs:E}}};(0,tslib_es6._)([(0,property/* property */.MZ)()],h.prototype,"featureDefinition",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({constructOnly:!0})],h.prototype,"layer",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)()],h.prototype,"type",void 0),h=(0,tslib_es6._)([(0,subclass/* subclass */.$)("esri.layers.graphics.sources.OGCFeatureSource")],h);
...
See https://js.arcgis.com/4.28/esri/copyright.txt for details.
*/
const M=(0,fieldProperties/* defineFieldProperties */.p)();let B=class extends((0,APIKeyMixin/* APIKeyMixin */.p)((0,CustomParametersMixin/* CustomParametersMixin */.d)((0,FeatureReductionLayer/* FeatureReductionLayer */.J)((0,FeatureEffectLayer/* FeatureEffectLayer */.F)((0,BlendLayer/* BlendLayer */.d)((0,OrderedLayer/* OrderedLayer */.f)((0,TemporalLayer/* TemporalLayer */.e)((0,ScaleRangeLayer/* ScaleRangeLayer */.j)((0,OperationalLayer/* OperationalLayer */.q)((0,PortalLayer/* PortalLayer */.A)((0,RefreshableLayer/* RefreshableLayer */.J)((0,MultiOriginJSONSupport/* MultiOriginJSONMixin */.P)(Layer/* default */.A))))))))))))){constructor(e){super(e),this.capabilities=null,this.collectionId=null,this.copyright=null,this.definitionExpression=null,this.description=null,this.displayField=null,this.elevationInfo=null,this.fields=null,this.fieldsIndex=null,this.fullExtent=null,this.geometryType=null,this.hasZ=void 0,this.labelingInfo=null,this.labelsVisible=!0,this.legendEnabled=!0,this.maxRecordCount=null,this.objectIdField=null,this.operationalLayerType="OGCFeatureLayer",this.popupEnabled=!0,this.popupTemplate=null,this.screenSizePerspectiveEnabled=!0,this.source=new h({layer:this}),this.spatialReference=null,this.title=null,this.type="ogc-feature",this.typeIdField=null,this.types=null,this.url=null}destroy(){this.source?.destroy()}load(e){return this.addResolvingPromise(this.loadFromPortal({supportedTypes:["OGCFeatureServer"]},e).then((()=>this._fetchService(e)))),this.when()}get defaultPopupTemplate(){return this.createPopupTemplate()}get effectiveMaxRecordCount(){return this.maxRecordCount??this.capabilities?.query.maxRecordCount??5e3}get isTable(){return this.loaded&&null==this.geometryType}set renderer(e){(0,fieldUtils/* fixRendererFields */.yp)(e,this.fieldsIndex),this._set("renderer",e)}on(e,r){return super.on(e,r)}createPopupTemplate(e){return (0,popupUtils/* createPopupTemplate */.tn)(this,e)}createQuery(){return new Query/* default */.A}getField(e){return this.fieldsIndex.get(e)}getFieldDomain(e,r){let t,i=!1;const o=r?.feature?.attributes,s=this.typeIdField&&o?.[this.typeIdField];return null!=s&&this.types&&(i=this.types.some((r=>r.id==s&&(t=r.domains?.[e],"inherited"===t?.type&&(t=this._getLayerDomain(e)),!0)))),i||t||(t=this._getLayerDomain(e)),t}queryFeatures(e,r){return this.load().then((()=>this.source.queryFeatures(Query/* default */.A.from(e)||this.createQuery(),r))).then((e=>(e?.features?.forEach((e=>{e.layer=e.sourceLayer=this})),e)))}serviceSupportsSpatialReference(e){return this.source?.serviceSupportsSpatialReference(e)??!1}async _fetchService(e){await this.source.load(e),this.read(this.source.featureDefinition,{origin:"service"}),(0,fieldUtils/* fixRendererFields */.yp)(this.renderer,this.fieldsIndex),(0,fieldUtils/* fixTimeInfoFields */.sv)(this.timeInfo,this.fieldsIndex)}_getLayerDomain(e){if(!this.fields)return null;for(const r of this.fields)if(r.name===e&&r.domain)return r.domain;return null}};(0,tslib_es6._)([(0,property/* property */.MZ)({readOnly:!0,json:{origins:{service:{read:!0}}}})],B.prototype,"capabilities",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:String,json:{write:!0}})],B.prototype,"collectionId",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:String})],B.prototype,"copyright",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({readOnly:!0})],B.prototype,"defaultPopupTemplate",null),(0,tslib_es6._)([(0,property/* property */.MZ)({type:String})],B.prototype,"definitionExpression",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({readOnly:!0,type:String,json:{origins:{service:{name:"collection.description"}}}})],B.prototype,"description",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:String})],B.prototype,"displayField",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:Number})],B.prototype,"effectiveMaxRecordCount",null),(0,tslib_es6._)([(0,property/* property */.MZ)(commonProperties/* elevationInfo */.Yj)],B.prototype,"elevationInfo",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:[Field/* default */.A],json:{origins:{service:{name:"layerDefinition.fields"}}}})],B.prototype,"fields",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)(M.fieldsIndex)],B.prototype,"fieldsIndex",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({readOnly:!0,type:Extent/* default */.A,json:{origins:{service:{name:"layerDefinition.extent"}}}})],B.prototype,"fullExtent",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:typeUtils/* featureGeometryTypeKebabDictionary */.g.apiValues,json:{origins:{service:{name:"layerDefinition.geometryType",read:{reader:typeUtils/* featureGeometryTypeKebabDictionary */.g.read}}}}})],B.prototype,"geometryType",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:Boolean,json:{origins:{service:{name:"layerDefinition.hasZ"}}}})],B.prototype,"hasZ",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:Boolean,readOnly:!0})],B.prototype,"isTable",null),(0,tslib_es6._)([(0,property/* property */.MZ)({type:[LabelClass/* default */.A],json:{origins:{"web-document":{name:"layerDefinition.drawingInfo.labelingInfo",read:{reader:labelingInfo/* reader */.w},write:!0}}}})],B.prototype,"labelingInfo",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)(commonProperties/* labelsVisible */.kF)],B.prototype,"labelsVisible",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)(commonProperties/* legendEnabled */.fV)],B.prototype,"legendEnabled",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:Number})],B.prototype,"maxRecordCount",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:String,json:{origins:{service:{name:"layerDefinition.objectIdField"}}}})],B.prototype,"objectIdField",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:["OGCFeatureLayer"]})],B.prototype,"operationalLayerType",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)(commonProperties/* popupEnabled */.M6)],B.prototype,"popupEnabled",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:PopupTemplate/* default */.A,json:{name:"popupInfo",write:!0}})],B.prototype,"popupTemplate",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({types:types/* rendererTypes */.H,json:{origins:{service:{name:"layerDefinition.drawingInfo.renderer",write:!1},"web-scene":{types:types/* webSceneRendererTypes */.X,name:"layerDefinition.drawingInfo.renderer",write:!0}},name:"layerDefinition.drawingInfo.renderer",write:!0}})],B.prototype,"renderer",null),(0,tslib_es6._)([(0,property/* property */.MZ)(commonProperties/* screenSizePerspectiveEnabled */.PY)],B.prototype,"screenSizePerspectiveEnabled",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({readOnly:!0})],B.prototype,"source",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({readOnly:!0,type:SpatialReference/* default */.A,json:{origins:{service:{read:!0}}}})],B.prototype,"spatialReference",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:String,json:{write:{enabled:!0,ignoreOrigin:!0,isRequired:!0},origins:{service:{name:"collection.title"}}}})],B.prototype,"title",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({readOnly:!0,json:{read:!1}})],B.prototype,"type",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:String,readOnly:!0})],B.prototype,"typeIdField",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)({type:[FeatureType/* default */.A]})],B.prototype,"types",void 0),(0,tslib_es6._)([(0,property/* property */.MZ)(commonProperties/* url */.OZ)],B.prototype,"url",void 0),B=(0,tslib_es6._)([(0,subclass/* subclass */.$)("esri.layers.OGCFeatureLayer")],B);const V=B;
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   GA: () => (/* binding */ k),
/* harmony export */   GL: () => (/* binding */ j),
/* harmony export */   I: () => (/* binding */ v),
/* harmony export */   J0: () => (/* binding */ x),
/* harmony export */   Ki: () => (/* binding */ T),
/* harmony export */   Px: () => (/* binding */ I),
/* harmony export */   QE: () => (/* binding */ h),
/* harmony export */   bV: () => (/* binding */ F),
/* harmony export */   bW: () => (/* binding */ S),
/* harmony export */   vJ: () => (/* binding */ b)
/* harmony export */ });
...
/* harmony import */ var _graphics_featureConversionUtils_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(21355);
/* harmony import */ var _graphics_OptimizedFeatureSet_js__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(46461);
/* harmony import */ var _graphics_sources_geojson_geojson_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(11984);
/* harmony import */ var _graphics_sources_support_clientSideDefaults_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(20061);
/* harmony import */ var _support_FieldsIndex_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(79005);
/* harmony import */ var _support_fieldType_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(17930);
/* harmony import */ var _time_timeZoneUtils_js__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(12129);
/* harmony import */ var _geometry_SpatialReference_js__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(78983);
/*
All material copyright ESRI, All Rights Reserved, unless otherwise specified.
See https://js.arcgis.com/4.28/esri/copyright.txt for details.
*/
const w=_core_Logger_js__WEBPACK_IMPORTED_MODULE_3__/* ["default"] */ .A.getLogger("esri.layers.graphics.sources.ogcfeature"),b="http://www.opengis.net/def/crs/",h=`${b}OGC/1.3/CRS84`;async function j(n,i,r={},a=5){const{links:o}=n,s=G(o,"items","application/geo+json")||G(o,"http://www.opengis.net/def/rel/ogc/1.0/items","application/geo+json");if(null==s)throw new _core_Error_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A("ogc-feature-layer:missing-items-page","Missing items url");const{data:l}=await (0,_request_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(s.href,{signal:r.signal,query:{limit:a,...r.customParameters,token:r.apiKey},headers:{accept:"application/geo+json"}});(0,_graphics_sources_geojson_geojson_js__WEBPACK_IMPORTED_MODULE_7__/* .validateGeoJSON */ .sO)(l);const d=(0,_graphics_sources_geojson_geojson_js__WEBPACK_IMPORTED_MODULE_7__/* .inferLayerProperties */ .BM)(l,{geometryType:i.geometryType}),y=i.fields||d.fields||[],b=null!=i.hasZ?i.hasZ:d.hasZ,h=d.geometryType,j=i.objectIdField||d.objectIdFieldName||"OBJECTID";let F=i.timeInfo;const I=y.find((({name:e})=>e===j));if(I)I.editable=!1,I.nullable=!1;else{if(!d.objectIdFieldType)throw new _core_Error_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A("ogc-feature-layer:missing-feature-id","Collection geojson require a feature id as a unique identifier");y.unshift({name:j,alias:j,type:"number"===d.objectIdFieldType?"esriFieldTypeOID":"esriFieldTypeString",editable:!1,nullable:!1})}if(j!==d.objectIdFieldName){const e=y.find((({name:e})=>e===d.objectIdFieldName));e&&(e.type="esriFieldTypeInteger")}y===d.fields&&d.unknownFields.length>0&&w.warn({name:"ogc-feature-layer:unknown-field-types",message:"Some fields types couldn't be inferred from the features and were dropped",details:{unknownFields:d.unknownFields}});for(const e of y){if(null==e.name&&(e.name=e.alias),null==e.alias&&(e.alias=e.name),"esriFieldTypeOID"!==e.type&&"esriFieldTypeGlobalID"!==e.type&&(e.editable=null==e.editable||!!e.editable,e.nullable=null==e.nullable||!!e.nullable),!e.name)throw new _core_Error_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A("ogc-feature-layer:invalid-field-name","field name is missing",{field:e});if(!_support_fieldType_js__WEBPACK_IMPORTED_MODULE_10__/* .kebabDict */ .m.jsonValues.includes(e.type))throw new _core_Error_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A("ogc-feature-layer:invalid-field-type",`invalid type for field "${e.name}"`,{field:e})}if(F){const e=new _support_FieldsIndex_js__WEBPACK_IMPORTED_MODULE_9__/* ["default"] */ .A(y);if(F.startTimeField){const t=e.get(F.startTimeField);t?(F.startTimeField=t.name,t.type="esriFieldTypeDate"):F.startTimeField=null}if(F.endTimeField){const t=e.get(F.endTimeField);t?(F.endTimeField=t.name,t.type="esriFieldTypeDate"):F.endTimeField=null}if(F.trackIdField){const t=e.get(F.trackIdField);t?F.trackIdField=t.name:(F.trackIdField=null,w.warn({name:"ogc-feature-layer:invalid-timeInfo-trackIdField",message:"trackIdField is missing",details:{timeInfo:F}}))}F.timeReference||={timeZoneIANA:_time_timeZoneUtils_js__WEBPACK_IMPORTED_MODULE_11__/* .utc */ .n$},F.startTimeField||F.endTimeField||(w.warn({name:"ogc-feature-layer:invalid-timeInfo",message:"startTimeField and endTimeField are missing",details:{timeInfo:F}}),F=null)}return{drawingInfo:h?(0,_graphics_sources_support_clientSideDefaults_js__WEBPACK_IMPORTED_MODULE_8__/* .createDrawingInfo */ .F0)(h):null,extent:$(n),geometryType:h,fields:y,hasZ:!!b,objectIdField:j,timeInfo:F}}async function F(n,i={}){const{links:r}=n,a=G(r,"data","application/json")||G(r,"http://www.opengis.net/def/rel/ogc/1.0/data","application/json");if(null==a)throw new _core_Error_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A("ogc-feature-layer:missing-collections-page","Missing collections url");const{apiKey:o,customParameters:s,signal:l}=i,{data:c}=await (0,_request_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(a.href,{signal:l,headers:{accept:"application/json"},query:{...s,token:o}});return c}async function I(n,i={}){const{links:r}=n,a=G(r,"conformance","application/json")||G(r,"http://www.opengis.net/def/rel/ogc/1.0/conformance","application/json");if(null==a)throw new _core_Error_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A("ogc-feature-layer:missing-conformance-page","Missing conformance url");const{apiKey:o,customParameters:s,signal:l}=i,{data:c}=await (0,_request_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(a.href,{signal:l,headers:{accept:"application/json"},query:{...s,token:o}});return c}async function T(t,n={}){const{apiKey:i,customParameters:r,signal:a}=n,{data:o}=await (0,_request_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(t,{signal:a,headers:{accept:"application/json"},query:{...r,token:i}});return o}async function k(t,n={}){const i="application/vnd.oai.openapi+json;version=3.0",r=G(t.links,"service-desc",i);if(null==r)return w.warn("ogc-feature-layer:missing-openapi-page","The OGC API-Features server does not have an OpenAPI page."),null;const{apiKey:a,customParameters:o,signal:s}=n,{data:l}=await (0,_request_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(r.href,{signal:s,headers:{accept:i},query:{...o,token:a}});return l}function x(e){const t=/^http:\/\/www\.opengis.net\/def\/crs\/(?<authority>.*)\/(?<version>.*)\/(?<code>.*)$/i.exec(e),n=t?.groups;if(!n)return null;const{authority:i,code:r}=n;switch(i.toLowerCase()){case"ogc":switch(r.toLowerCase()){case"crs27":return _geometry_SpatialReference_js__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .A.GCS_NAD_1927.wkid;case"crs83":return 4269;case"crs84":case"crs84h":return _geometry_SpatialReference_js__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .A.WGS84.wkid;default:return null}case"esri":case"epsg":{const e=Number.parseInt(r,10);return Number.isNaN(e)?null:e}default:return null}}async function S(e,t,n){const i=await v(e,t,n);return (0,_graphics_featureConversionUtils_js__WEBPACK_IMPORTED_MODULE_6__/* .convertToFeatureSet */ .ZF)(i)}async function v(n,a,c){const{collection:u,layerDefinition:m,maxRecordCount:p,queryParameters:{apiKey:f,customParameters:g},spatialReference:w,supportedCrs:b}=n,{links:h}=u,j=G(h,"items","application/geo+json")||G(h,"http://www.opengis.net/def/rel/ogc/1.0/items","application/geo+json");if(null==j)throw new _core_Error_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A("ogc-feature-layer:missing-items-page","Missing items url");const{geometry:F,num:I,start:T,timeExtent:k,where:x}=a;if(a.objectIds)throw new _core_Error_js__WEBPACK_IMPORTED_MODULE_2__/* ["default"] */ .A("ogc-feature-layer:query-by-objectids-not-supported","Queries with objectids are not supported");const S=_geometry_SpatialReference_js__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .A.fromJSON(w),v=a.outSpatialReference??S,N=v.isWGS84?null:R(v,b),q=M(F,b),$=O(k),W=C(x),D=I??(null!=T&&void 0!==T?10:p),{data:P}=await (0,_request_js__WEBPACK_IMPORTED_MODULE_1__/* ["default"] */ .A)(j.href,{...c,query:{...g,...q,crs:N,datetime:$,query:W,limit:D,startindex:T,token:f},headers:{accept:"application/geo+json"}});let Z=!1;if(P.links){const e=P.links.find((e=>"next"===e.rel));Z=!!e}!Z&&Number.isInteger(P.numberMatched)&&Number.isInteger(P.numberReturned)&&(Z=P.numberReturned<P.numberMatched);const{fields:K,geometryType:A,hasZ:L,objectIdField:J}=m,U=(0,_graphics_sources_geojson_geojson_js__WEBPACK_IMPORTED_MODULE_7__/* .createOptimizedFeatures */ .bd)(P,{geometryType:A,hasZ:L,objectIdField:J});if(!N&&v.isWebMercator)for(const e of U)if(null!=e.geometry&&null!=A){const t=(0,_graphics_featureConversionUtils_js__WEBPACK_IMPORTED_MODULE_6__/* .convertToGeometry */ .zv)(e.geometry,A,L,!1);t.spatialReference=_geometry_SpatialReference_js__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .A.WGS84,e.geometry=(0,_graphics_featureConversionUtils_js__WEBPACK_IMPORTED_MODULE_6__/* .convertFromGeometry */ .Ux)((0,_geometry_support_webMercatorUtils_js__WEBPACK_IMPORTED_MODULE_5__/* .project */ .Cv)(t,v))}for(const e of U)e.objectId=e.attributes[J];const z=N||!N&&v.isWebMercator?v.toJSON():_geometry_support_spatialReferenceUtils_js__WEBPACK_IMPORTED_MODULE_4__/* .WGS84 */ .w5,E=new _graphics_OptimizedFeatureSet_js__WEBPACK_IMPORTED_MODULE_13__/* ["default"] */ .A;return E.exceededTransferLimit=Z,E.features=U,E.fields=K,E.geometryType=A,E.hasZ=L,E.objectIdFieldName=J,E.spatialReference=z,E}function N(e){return null!=e&&"extent"===e.type}function R(e,t){const{isWebMercator:n,wkid:i}=e;if(!i)return null;const r=n?t[3857]??t[102100]??t[102113]??t[900913]:t[e.wkid];return r?`${b}${r}`:null}function q(e){if(null==e)return"";const{xmin:t,ymin:n,xmax:i,ymax:r}=e;return`${t},${n},${i},${r}`}function O(e){if(null==e)return null;const{start:t,end:n}=e;return`${null!=t?t.toISOString():".."}/${null!=n?n.toISOString():".."}`}function C(e){return null!=e&&e&&"1=1"!==e?e:null}function M(e,t){if(!N(e))return null;const{spatialReference:n}=e;if(!n||n.isWGS84)return{bbox:q(e)};const i=R(n,t);return null!=i?{bbox:q(e),"bbox-crs":i}:n.isWebMercator?{bbox:q((0,_geometry_support_webMercatorUtils_js__WEBPACK_IMPORTED_MODULE_5__/* .project */ .Cv)(e,_geometry_SpatialReference_js__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .A.WGS84))}:null}function $(e){const t=e.extent?.spatial;if(!t)return null;const n=t.bbox[0],i=4===n.length,r=n[0],a=n[1],o=i?void 0:n[2];return{xmin:r,ymin:a,xmax:i?n[2]:n[3],ymax:i?n[3]:n[4],zmin:o,zmax:i?void 0:n[5],spatialReference:_geometry_SpatialReference_js__WEBPACK_IMPORTED_MODULE_12__/* ["default"] */ .A.WGS84.toJSON()}}function G(e,t,n){return e.find((e=>e.rel===t&&e.type===n))||e.find((e=>e.rel===t&&!e.type))}
